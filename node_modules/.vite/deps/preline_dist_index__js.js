...
var require_dist = __commonJS({
  "node_modules/preline/dist/index.js"(exports, module) {
    !(function(e, t) {
      ...
      var e = { 60: function(e2, t2, i2) {
        ...
        class l extends o.default {
          ...
          constructor(e3, t3) {
            super(e3, t3);
            const i3 = e3.getAttribute("data-hs-pin-input"), s2 = i3 ? JSON.parse(i3) : {}, n2 = Object.assign(Object.assign({}, s2), t3);
          ...
          onInput(e3, t3) {
            ...
            if (this.setCurrentValue(), this.currentItem.value) {
              if (t3 < this.items.length - 1 && this.items[t3 + 1].focus(), !this.currentValue.includes("")) {
                ...
                this.fireEvent("completed", e4), (0, n.dispatch)("completed.hs.pinInput", this.el, e4);
              }
        ...
        class l extends o.default {
          constructor(e3, t3) {
            ...
            const i3 = e3.getAttribute("data-hs-strong-password"), s2 = i3 ? JSON.parse(i3) : {}, n2 = Object.assign(Object.assign({}, s2), t3);
          ...
          setStrength(e3) {
            ...
            this.hideStrips(t3), this.fireEvent("change", s2), (0, n.dispatch)("change.hs.strongPassword", this.el, s2);
          }
          hideStrips(e3) {
        ...
        class l extends o.default {
          constructor(e3, t3) {
            super(e3, t3);
            const i3 = e3.getAttribute("data-hs-toggle-password"), s2 = i3 ? JSON.parse(i3) : {}, o2 = Object.assign(Object.assign({}, s2), t3), l2 = [];
            ...
            this.target = l2, this.isShown = !!this.el.hasAttribute("type") && this.el.checked, this.eventType = (0, n.isFormElement)(this.el) ? "change" : "click", this.isMultiple = this.target.length > 1 && !!this.el.closest("[data-hs-toggle-password-group]"), this.target && this.init();
          }
          elementAction() {
            this.isShown ? this.hide() : this.show(), this.fireEvent("toggle", this.target), (0, n.dispatch)("toggle.hs.toggle-select", this.el, this.target);
          }
          init() {
        ...
        Object.defineProperty(t2, "__esModule", { value: true });
        const n = i2(292), o = s(i2(632)), l = i2(191), a = i2(852), r = i2(292), d = s(i2(442)), c = s(i2(961));
        class h extends c.default {
          constructor(e3, t3, i3) {
            var s2, a2, r2, d2, c2, h2, u;
            super(e3, t3, i3);
            const p = e3.getAttribute("data-hs-datepicker") ? JSON.parse(e3.getAttribute("data-hs-datepicker")) : {};
            this.dataOptions = Object.assign(Object.assign({}, p), t3);
            const m = void 0 !== (null === (s2 = this.dataOptions) || void 0 === s2 ? void 0 : s2.removeDefaultStyles) && (null === (a2 = this.dataOptions) || void 0 === a2 ? void 0 : a2.removeDefaultStyles);
            this.updatedStyles = _.mergeWith(m ? {} : o.default.defaultStyles, (null === (r2 = this.dataOptions) || void 0 === r2 ? void 0 : r2.styles) || {}, ((e4, t4) => {
              if ("string" == typeof e4 && "string" == typeof t4) return `${e4} ${t4}`;
            }));
            const g = /* @__PURE__ */ new Date(), v = { selectedTheme: null !== (d2 = this.dataOptions.selectedTheme) && void 0 !== d2 ? d2 : "", styles: this.updatedStyles, dateMin: null !== (c2 = this.dataOptions.dateMin) && void 0 !== c2 ? c2 : g.toISOString().split("T")[0], dateMax: null !== (h2 = this.dataOptions.dateMax) && void 0 !== h2 ? h2 : "2470-12-31", mode: null !== (u = this.dataOptions.mode) && void 0 !== u ? u : "default", inputMode: void 0 === this.dataOptions.inputMode || this.dataOptions.inputMode }, f = (e4, t4) => (i4) => {
              null == e4 || e4(i4), null == t4 || t4(i4);
            }, y = (e4) => {
              this.hasTime(e4) && this.initCustomTime(e4);
            }, w = { layouts: { month: l.templates.month(v.selectedTheme) }, onInit: f(this.dataOptions.onInit, ((e4) => {
              "custom-select" !== v.mode || this.dataOptions.inputMode || y(e4);
            })), onShow: f(this.dataOptions.onShow, ((e4) => {
              "custom-select" === v.mode && (this.updateCustomSelects(e4), y(e4));
            })), onHide: f(this.dataOptions.onHide, ((e4) => {
              "custom-select" === v.mode && this.destroySelects(e4.context.mainElement);
            })), onUpdate: f(this.dataOptions.onUpdate, ((e4) => {
              this.updateCalendar(e4.context.mainElement);
            })), onCreateDateEls: f(this.dataOptions.onCreateDateEls, ((e4) => {
              "custom-select" === v.mode && this.updateCustomSelects(e4);
            })), onChangeToInput: f(this.dataOptions.onChangeToInput, ((e4) => {
              ...
              this.fireEvent("change", t4), (0, n.dispatch)("change.hs.datepicker", this.el, t4);
            })), onChangeTime: f(this.dataOptions.onChangeTime, y), onClickYear: f(this.dataOptions.onClickYear, y), onClickMonth: f(this.dataOptions.onClickMonth, y), onClickArrow: f(this.dataOptions.onClickArrow, ((e4) => {
              "custom-select" === v.mode && setTimeout((() => {
            ...
            const b = Object.assign(Object.assign({}, v), { layouts: { default: this.processCustomTemplate(l.templates.default(v.selectedTheme), "default"), multiple: this.processCustomTemplate(l.templates.multiple(v.selectedTheme), "multiple"), year: this.processCustomTemplate(l.templates.year(v.selectedTheme), "default") } });
            this.concatOptions = _.merge(this.concatOptions, b), this.vanillaCalendar = new o.default(this.el, this.concatOptions), this.init();
          }
          init() {
            var e3, t3;
          ...
          getTimeParts(e3) {
            const [t3, i3] = e3.split(" "), [s2, n2] = t3.split(":");
            return [s2, n2, i3];
          }
          ...
          setInputValue(e3, t3) {
            var i3, s2, n2, o2, l2, a2, r2, d2, c2;
            const h2 = null === (i3 = this.dataOptions) || void 0 === i3 ? void 0 : i3.dateFormat, u = null !== (o2 = null === (n2 = null === (s2 = this.dataOptions) || void 0 === s2 ? void 0 : s2.inputModeOptions) || void 0 === n2 ? void 0 : n2.dateSeparator) && void 0 !== o2 ? o2 : ".", p = null !== (r2 = null === (a2 = null === (l2 = this.dataOptions) || void 0 === l2 ? void 0 : l2.inputModeOptions) || void 0 === a2 ? void 0 : a2.itemsSeparator) && void 0 !== r2 ? r2 : ", ", m = null !== (c2 = null === (d2 = this.dataOptions) || void 0 === d2 ? void 0 : d2.selectionDatesMode) && void 0 !== c2 ? c2 : "single";
            if (t3.length && t3.length > 1) if ("multiple" === m) {
              const i4 = [];
              t3.forEach(((e4) => i4.push(h2 ? this.formatDate(e4, h2) : this.changeDateSeparator(e4, u)))), e3.value = i4.join(p);
            } else {
              const i4 = h2 ? this.formatDate(t3[0], h2) : this.changeDateSeparator(t3[0], u), s3 = h2 ? this.formatDate(t3[1], h2) : this.changeDateSeparator(t3[1], u);
              e3.value = [i4, s3].join(p);
            }
            else t3.length && 1 === t3.length ? e3.value = h2 ? this.formatDate(t3[0], h2) : this.changeDateSeparator(t3[0], u) : e3.value = "";
          }
          getLocalizedTodayText(e3) {
            return a.todayTranslations[e3] || "Today";
          }
          changeDateSeparator(e3, t3 = ".", i3 = "-") {
            var s2, n2;
            const o2 = new Date(e3);
            if (null === (s2 = this.dataOptions) || void 0 === s2 ? void 0 : s2.replaceTodayWithText) {
              const e4 = /* @__PURE__ */ new Date();
              if (o2.toDateString() === e4.toDateString()) {
                const e5 = null === (n2 = this.dataOptions) || void 0 === n2 ? void 0 : n2.dateLocale;
          ...
          formatDateArrayToIndividualDates(e3) {
            var t3, i3;
            const s2 = null !== (i3 = null === (t3 = this.dataOptions) || void 0 === t3 ? void 0 : t3.selectionDatesMode) && void 0 !== i3 ? i3 : "single";
            return e3.flatMap(((e4) => {
              if ("string" == typeof e4) {
                ...
                if (t4) {
                  const [e5, i4, n2] = t4;
                  return "multiple-ranged" === s2 ? [i4, n2] : ((e6, t5) => {
                    const i5 = new Date(e6), s3 = new Date(t5), n3 = [];
                    for (; i5 <= s3; ) n3.push(i5.toISOString().split("T")[0]), i5.setDate(i5.getDate() + 1);
                    return n3;
                  })(i4.trim(), n2.trim());
                }
                return [e4];
          ...
          hasTime(e3) {
            const { mainElement: t3 } = e3.context, i3 = t3.querySelector("[data-hs-select].--hours"), s2 = t3.querySelector("[data-hs-select].--minutes"), n2 = t3.querySelector("[data-hs-select].--meridiem");
            return i3 && s2 && n2;
          }
          createArrowFromTemplate(e3, t3 = false) {
            if (!t3) return e3;
            const i3 = (0, r.htmlToElement)(e3);
            return (0, r.classToClassList)(t3, i3), i3.outerHTML;
          }
          concatObjectProperties(e3, t3) {
            const i3 = {};
            return (/* @__PURE__ */ new Set([...Object.keys(e3 || {}), ...Object.keys(t3 || {})])).forEach(((s2) => {
              const n2 = e3[s2] || "", o2 = t3[s2] || "";
              i3[s2] = `${n2} ${o2}`.trim();
            })), i3;
          }
          updateTemplate(e3, t3, i3) {
            if (!t3) return e3;
            const s2 = JSON.parse(e3.match(/data-hs-select='([^']+)'/)[1]), n2 = this.concatObjectProperties(t3, i3), o2 = _.merge(s2, n2);
            return e3.replace(/data-hs-select='[^']+'/, `data-hs-select='${JSON.stringify(o2)}'`);
          }
          initCustomTime(e3) {
            var t3;
            const { mainElement: i3 } = e3.context, s2 = this.getTimeParts(null !== (t3 = e3.selectedTime) && void 0 !== t3 ? t3 : "12:00 PM"), n2 = { hours: i3.querySelector("[data-hs-select].--hours"), minutes: i3.querySelector("[data-hs-select].--minutes"), meridiem: i3.querySelector("[data-hs-select].--meridiem") };
            Object.entries(n2).forEach((([t4, n3]) => {
              if (!d.default.getInstance(n3, true)) {
                const o2 = new d.default(n3);
                o2.setValue(s2["meridiem" === t4 ? 2 : "minutes" === t4 ? 1 : 0]), o2.el.addEventListener("change.hs.select", ((n4) => {
                  this.destroySelects(i3);
                  const o3 = "hours" === t4 ? n4.detail.payload : s2[0], l2 = "minutes" === t4 ? n4.detail.payload : s2[1], a2 = "meridiem" === t4 ? n4.detail.payload : s2[2];
          ...
          initCustomMonths(e3) {
            ...
            i3.length && i3.forEach(((i4, s2) => {
              const n2 = i4.querySelector("[data-hs-select].--month");
              if (d.default.getInstance(n2, true)) return false;
              const o2 = new d.default(n2), { month: l2, year: a2 } = this.getCurrentMonthAndYear(i4);
              o2.setValue(`${l2}`), o2.el.addEventListener("change.hs.select", ((i5) => {
                this.destroySelects(t3), e3.set({ selectedMonth: +i5.detail.payload - s2 < 0 ? 11 : +i5.detail.payload - s2, selectedYear: +i5.detail.payload - s2 < 0 ? +a2 - 1 : a2 }, { dates: false, time: false });
              }));
            }));
          }
          initCustomYears(e3) {
            ...
            i3.length && i3.forEach(((i4) => {
              const s2 = i4.querySelector("[data-hs-select].--year");
              if (d.default.getInstance(s2, true)) return false;
              const n2 = new d.default(s2), { month: o2, year: l2 } = this.getCurrentMonthAndYear(i4);
              n2.setValue(`${l2}`), n2.el.addEventListener("change.hs.select", ((i5) => {
                const { dateMax: s3, displayMonthsCount: n3 } = this.vanillaCalendar.context, l3 = new Date(s3).getFullYear(), a2 = new Date(s3).getMonth();
                this.destroySelects(t3), e3.set({ selectedMonth: o2 > a2 - n3 && +i5.detail.payload === l3 ? a2 - n3 + 1 : o2, selectedYear: i5.detail.payload }, { dates: false, time: false });
              }));
            }));
          }
          generateCustomTimeMarkup() {
            var e3, t3, i3, s2;
            const n2 = null === (e3 = this.updatedStyles) || void 0 === e3 ? void 0 : e3.customSelect, o2 = n2 ? this.updateTemplate(l.templates.hours(this.concatOptions.selectedTheme), (null == n2 ? void 0 : n2.shared) || {}, (null == n2 ? void 0 : n2.hours) || {}) : l.templates.hours(this.concatOptions.selectedTheme), a2 = n2 ? this.updateTemplate(l.templates.minutes(this.concatOptions.selectedTheme), (null == n2 ? void 0 : n2.shared) || {}, (null == n2 ? void 0 : n2.minutes) || {}) : l.templates.minutes(this.concatOptions.selectedTheme), r2 = n2 ? this.updateTemplate(l.templates.meridiem(this.concatOptions.selectedTheme), (null == n2 ? void 0 : n2.shared) || {}, (null == n2 ? void 0 : n2.meridiem) || {}) : l.templates.meridiem(this.concatOptions.selectedTheme);
            return `<div class="--time">${null !== (s2 = null === (i3 = null === (t3 = null == this ? void 0 : this.dataOptions) || void 0 === t3 ? void 0 : t3.templates) || void 0 === i3 ? void 0 : i3.time) && void 0 !== s2 ? s2 : `
		...
		`}</div>`;
          ...
          generateCustomMonthMarkup() {
            var e3, t3, i3;
            const s2 = null !== (t3 = null === (e3 = null == this ? void 0 : this.dataOptions) || void 0 === e3 ? void 0 : e3.mode) && void 0 !== t3 ? t3 : "default", n2 = null === (i3 = this.updatedStyles) || void 0 === i3 ? void 0 : i3.customSelect, o2 = n2 ? this.updateTemplate(l.templates.months(this.concatOptions.selectedTheme), (null == n2 ? void 0 : n2.shared) || {}, (null == n2 ? void 0 : n2.months) || {}) : l.templates.months(this.concatOptions.selectedTheme);
            return "custom-select" === s2 ? o2 : "<#Month />";
          }
          generateCustomYearMarkup() {
            var e3, t3, i3, s2, n2, o2, a2;
            if ("custom-select" === (null !== (t3 = null === (e3 = null == this ? void 0 : this.dataOptions) || void 0 === e3 ? void 0 : e3.mode) && void 0 !== t3 ? t3 : "default")) {
              const e4 = /* @__PURE__ */ new Date(), t4 = null !== (s2 = null === (i3 = null == this ? void 0 : this.dataOptions) || void 0 === i3 ? void 0 : i3.dateMin) && void 0 !== s2 ? s2 : e4.toISOString().split("T")[0], r2 = null !== (o2 = null === (n2 = null == this ? void 0 : this.dataOptions) || void 0 === n2 ? void 0 : n2.dateMax) && void 0 !== o2 ? o2 : "2470-12-31", d2 = new Date(t4), c2 = new Date(r2), h2 = d2.getFullYear(), u = c2.getFullYear(), p = () => {
                let e5 = "";
                for (let t5 = h2; t5 <= u; t5++) e5 += `<option value="${t5}">${t5}</option>`;
                return e5;
              }, m = l.templates.years(p(), this.concatOptions.selectedTheme), g = null === (a2 = this.updatedStyles) || void 0 === a2 ? void 0 : a2.customSelect;
          ...
          processCustomTemplate(e3, t3) {
            var i3, s2, n2, o2;
            const l2 = "default" === t3 ? null === (s2 = null === (i3 = null == this ? void 0 : this.dataOptions) || void 0 === i3 ? void 0 : i3.layouts) || void 0 === s2 ? void 0 : s2.default : null === (o2 = null === (n2 = null == this ? void 0 : this.dataOptions) || void 0 === n2 ? void 0 : n2.layouts) || void 0 === o2 ? void 0 : o2.multiple, a2 = this.parseCustomMonth(null != l2 ? l2 : e3), r2 = this.parseCustomYear(a2), d2 = this.parseCustomTime(r2), c2 = this.parseArrowPrev(d2);
            return this.parseArrowNext(c2);
          }
          disableOptions() {
            const { mainElement: e3, dateMax: t3, displayMonthsCount: i3 } = this.vanillaCalendar.context, s2 = new Date(t3);
            Array.from(e3.querySelectorAll(".--single-month")).forEach(((e4, t4) => {
              var n2;
              const o2 = +(null === (n2 = e4.querySelector('[data-vc="year"]')) || void 0 === n2 ? void 0 : n2.getAttribute("data-vc-year")), l2 = e4.querySelectorAll("[data-hs-select].--month option"), a2 = e4.querySelectorAll("[data-hs-select-dropdown] [data-value]"), r2 = (e5) => +e5.getAttribute("data-value") > s2.getMonth() - i3 + t4 + 1 && o2 === s2.getFullYear();
              Array.from(l2).forEach(((e5) => e5.toggleAttribute("disabled", r2(e5)))), Array.from(a2).forEach(((e5) => e5.classList.toggle("disabled", r2(e5))));
            }));
          }
          disableNav() {
            const { mainElement: e3, dateMax: t3, selectedYear: i3, selectedMonth: s2, displayMonthsCount: n2 } = this.vanillaCalendar.context, o2 = new Date(t3).getFullYear(), l2 = e3.querySelector('[data-vc-arrow="next"]');
            l2.style.visibility = i3 === o2 && s2 + n2 > 11 ? "hidden" : "";
          }
          destroySelects(e3) {
            Array.from(e3.querySelectorAll("[data-hs-select]")).forEach(((e4) => {
              const t3 = d.default.getInstance(e4, true);
              t3 && t3.element.destroy();
            }));
          }
          updateSelect(e3, t3) {
            const i3 = d.default.getInstance(e3, true);
          ...
          formatDate(e3, t3) {
            var i3, s2, n2, o2, l2, a2, r2;
            const d2 = t3 || (null === (i3 = this.dataOptions) || void 0 === i3 ? void 0 : i3.dateFormat), c2 = (null === (s2 = this.dataOptions) || void 0 === s2 ? void 0 : s2.dateLocale) || void 0;
            if (!d2) {
              const t4 = null !== (l2 = null === (o2 = null === (n2 = this.dataOptions) || void 0 === n2 ? void 0 : n2.inputModeOptions) || void 0 === o2 ? void 0 : o2.dateSeparator) && void 0 !== l2 ? l2 : ".";
              return this.changeDateSeparator(e3, t4);
            }
            const h2 = new Date(e3);
            if (isNaN(h2.getTime())) return this.changeDateSeparator(e3);
            let u = "", p = 0;
            for (; p < d2.length; ) if ("YYYY" === d2.slice(p, p + 4)) u += h2.getFullYear().toString(), p += 4;
            else if ("dddd" === d2.slice(p, p + 4)) {
              const e4 = h2.toLocaleDateString(c2, { weekday: "long" });
              if (null === (a2 = this.dataOptions) || void 0 === a2 ? void 0 : a2.replaceTodayWithText) {
                const t4 = /* @__PURE__ */ new Date();
                u += h2.toDateString() === t4.toDateString() ? this.getLocalizedTodayText(c2) : e4;
              } else u += e4;
              p += 4;
            } else if ("MMMM" === d2.slice(p, p + 4)) u += h2.toLocaleDateString(c2, { month: "long" }), p += 4;
            else if ("ddd" === d2.slice(p, p + 3)) {
              const e4 = h2.toLocaleDateString(c2, { weekday: "short" });
              if (null === (r2 = this.dataOptions) || void 0 === r2 ? void 0 : r2.replaceTodayWithText) {
                const t4 = /* @__PURE__ */ new Date();
                u += h2.toDateString() === t4.toDateString() ? this.getLocalizedTodayText(c2) : e4;
              } else u += e4;
              p += 3;
            } else "MMM" === d2.slice(p, p + 3) ? (u += h2.toLocaleDateString(c2, { month: "short" }), p += 3) : "YY" === d2.slice(p, p + 2) ? (u += h2.getFullYear().toString().slice(-2), p += 2) : "MM" === d2.slice(p, p + 2) ? (u += String(h2.getMonth() + 1).padStart(2, "0"), p += 2) : "DD" === d2.slice(p, p + 2) ? (u += String(h2.getDate()).padStart(2, "0"), p += 2) : "HH" === d2.slice(p, p + 2) ? (u += String(h2.getHours()).padStart(2, "0"), p += 2) : "mm" === d2.slice(p, p + 2) ? (u += String(h2.getMinutes()).padStart(2, "0"), p += 2) : "ss" === d2.slice(p, p + 2) ? (u += String(h2.getSeconds()).padStart(2, "0"), p += 2) : "Y" === d2[p] ? (u += h2.getFullYear().toString(), p += 1) : "M" === d2[p] ? (u += String(h2.getMonth() + 1), p += 1) : "D" === d2[p] ? (u += String(h2.getDate()), p += 1) : "H" === d2[p] ? (u += String(h2.getHours()), p += 1) : "m" === d2[p] ? (u += String(h2.getMinutes()), p += 1) : "s" === d2[p] ? (u += String(h2.getSeconds()), p += 1) : (u += d2[p], p += 1);
            return u;
          }
          destroy() {
            this.vanillaCalendar && (this.vanillaCalendar.destroy(), this.vanillaCalendar = null), window.$hsDatepickerCollection = window.$hsDatepickerCollection.filter((({ element: e3 }) => e3.el !== this.el));
          }
          static getInstance(e3, t3) {
        ...
        window.addEventListener("load", (() => {
          h.autoInit();
        })), "undefined" != typeof window && (window.HSDatepicker = h), t2.default = h;
        ...
        class o extends n.default {
          constructor(e3, t3) {
            super(e3, t3);
            const i3 = e3.getAttribute("data-hs-copy-markup"), s2 = i3 ? JSON.parse(i3) : {}, n2 = Object.assign(Object.assign({}, s2), t3);
            this.defaultHeight = (null == n2 ? void 0 : n2.defaultHeight) || 0, this.init();
          }
          elementInput() {
          ...
          callbackAccordingToType() {
            ...
            if ("collapse" === this.parentType()) {
              ...
              {
                const t3 = null === (e3 = this.el.closest('[role="tabpanel"]')) || void 0 === e3 ? void 0 : e3.id, i3 = document.querySelector(`[data-hs-tab="#${t3}"]`).closest('[role="tablist"]'), { element: s2 } = window.HSTabs.getInstance(i3, true) || null;
                s2.on("change", ((e4) => {
        ...
        if (Object.defineProperty(t2, "HSStaticMethods", { enumerable: true, get: function() {
          ...
          try {
            "undefined" != typeof DataTable && "undefined" != typeof jQuery && (t2.HSDataTable = o = i2(814).default);
          } catch (e3) {
            console.warn("HSDataTable: Required dependencies not found"), t2.HSDataTable = o = null;
          }
          try {
            "undefined" != typeof _ && "undefined" != typeof Dropzone && (t2.HSFileUpload = l = i2(234).default);
          } catch (e3) {
            console.warn("HSFileUpload: Required dependencies not found"), t2.HSFileUpload = l = null;
          }
          try {
            "undefined" != typeof noUiSlider && (t2.HSRangeSlider = a = i2(347).default);
          } catch (e3) {
            console.warn("HSRangeSlider: Required dependencies not found"), t2.HSRangeSlider = a = null;
          }
          try {
            "undefined" != typeof VanillaCalendarPro && (t2.HSDatepicker = r = i2(128).default);
          } catch (e3) {
            console.warn("HSDatepicker: Required dependencies not found"), t2.HSDatepicker = r = null;
          }
        }
        ...
        Object.defineProperty(t2, "__esModule", { value: true });
        const n = i2(292), o = s(i2(961)), l = s(i2(248)), a = i2(223);
        class r extends o.default {
          constructor(e3, t3, i3) {
            var s2, n2;
            super(e3, t3, i3);
            const o2 = e3.getAttribute("data-hs-tabs"), l2 = o2 ? JSON.parse(o2) : {}, r2 = Object.assign(Object.assign({}, l2), t3);
            this.eventType = null !== (s2 = r2.eventType) && void 0 !== s2 ? s2 : "click", this.preventNavigationResolution = "number" == typeof r2.preventNavigationResolution ? r2.preventNavigationResolution : a.BREAKPOINTS[r2.preventNavigationResolution] || null, this.toggles = this.el.querySelectorAll("[data-hs-tab]"), this.extraToggleId = this.el.getAttribute("data-hs-tab-select"), this.extraToggle = this.extraToggleId ? document.querySelector(this.extraToggleId) : null, this.current = Array.from(this.toggles).find(((e4) => e4.classList.contains("active"))), this.currentContentId = (null === (n2 = this.current) || void 0 === n2 ? void 0 : n2.getAttribute("data-hs-tab")) || null, this.currentContent = this.currentContentId ? document.querySelector(this.currentContentId) : null, this.prev = null, this.prevContentId = null, this.prevContent = null, this.onToggleHandler = [], this.init();
          }
          toggle(e3) {
            this.open(e3);
          }
        ...
        "use strict";
        Object.defineProperty(t2, "__esModule", { value: true }), t2.templates = void 0, t2.templates = { default: (e3 = false) => `<div class="--single-month flex flex-col overflow-hidden">
  ...
  </div>`, month: (e3 = false) => `<div class="pb-3" data-vc="header" role="toolbar">
    <div class="flex justify-center items-center gap-x-1" data-vc-header="content">
      <#Month />
      <span class="text-gray-800 ${"light" !== e3 ? "dark:text-neutral-200" : ""}">/</span>
      <#Year />
      ...
      <svg class="shrink-0 size-3 text-gray-500 ${"light" !== e3 ? "dark:text-neutral-500" : ""}" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m7 15 5 5 5-5"/><path d="m7 9 5-5 5 5"/></svg>
        ...
        class l extends o.default {
          ...
          onUploadProgress(e3, t3) {
            ...
            if (!i3) return false;
            const s2 = i3.querySelector("[data-hs-file-upload-progress-bar]"), n2 = i3.querySelector("[data-hs-file-upload-progress-bar-pane]"), o2 = i3.querySelector("[data-hs-file-upload-progress-bar-value]"), l2 = Math.floor(t3);
            ...
            if (this.activeComponent = this.getActiveComponent(t3), this.activeComponent && this.isAllowedKeybinding(e3)) switch (e3.key) {
              case "Escape":
                if (this.activeComponent.isOpened) this.activeComponent.handlers.onEsc && (this.activeComponent.handlers.onEsc(), e3.preventDefault(), e3.stopPropagation());
                  ...
                  const i3 = this.findClosestOpenParent(t3);
                  (null == i3 ? void 0 : i3.handlers.onEsc) && (i3.handlers.onEsc(), e3.preventDefault(), e3.stopPropagation());
                }
                break;
              case "Enter":
              ...
              case "Tab":
                ...
                const i2 = e3.shiftKey ? this.activeComponent.handlers.onShiftTab : this.activeComponent.handlers.onTab;
                i2 && i2();
                break;
              case "Home":
        ...
        const n = s(i2(406)), o = s(i2(740)), l = s(i2(268)), a = s(i2(485)), r = s(i2(809));
        let d, c, h, u;
        const p = s(i2(891)), m = s(i2(812)), g = s(i2(332)), v = s(i2(850)), f = s(i2(60)), y = s(i2(911)), w = s(i2(639)), b = s(i2(751)), C = s(i2(442)), S = s(i2(887)), x = s(i2(97)), L = s(i2(166)), E = s(i2(144)), T = s(i2(502)), k = s(i2(684)), I = s(i2(100)), A = s(i2(969)), M = s(i2(772));
        if ("undefined" != typeof window) {
          try {
            "undefined" != typeof DataTable && "undefined" != typeof jQuery && (d = i2(814).default);
          } catch (e3) {
            console.warn("HSDataTable: Required dependencies not found"), d = null;
          }
          try {
            "undefined" != typeof _ && "undefined" != typeof Dropzone && (c = i2(234).default);
          } catch (e3) {
        ...
        class a extends o.default {
          ...
          setIsSnap() {
            ...
            Array.from(this.inner.children).forEach(((e4) => {
              const s3 = e4.getBoundingClientRect(), o2 = this.inner.getBoundingClientRect(), l2 = s3.left + s3.width / 2 - o2.left, a2 = Math.abs(t3 - (o2.left + l2));
              a2 < n2 && (n2 = a2, i3 = e4);
          ...
          buildSnapSpacers() {
            ...
            const i3 = this.sliderWidth, s2 = i3 / 2 - i3 / this.getCurrentSlidesQty() / 2, o2 = (0, n.htmlToElement)(`<div class="hs-snap-before" style="height: 100%; width: ${s2}px"></div>`), l2 = (0, n.htmlToElement)(`<div class="hs-snap-after" style="height: 100%; width: ${s2}px"></div>`);
          ...
          goToCurrentDot() {
            const e3 = this.dots, t3 = e3.getBoundingClientRect(), i3 = e3.scrollLeft, s2 = e3.scrollTop, n2 = e3.clientWidth, o2 = e3.clientHeight, l2 = this.dotsItems[this.currentIndex], a2 = l2.getBoundingClientRect(), r = a2.left - t3.left + i3, d = r + l2.clientWidth, c = a2.top - t3.top + s2, h = c + l2.clientHeight;
            let u = i3, p = s2;
            (r < i3 || d > i3 + n2) && (u = d - n2), (c < s2 || h > s2 + o2) && (p = h - o2), e3.scrollTo({ left: u, top: p, behavior: "smooth" });
          }
          buildInfo() {
        ...
        t2.isEnoughSpace = (e3, t3, i3 = "auto", s2 = 10, n2 = null) => {
          const o = t3.getBoundingClientRect(), l = n2 ? n2.getBoundingClientRect() : null, a = window.innerHeight, r = l ? o.top - l.top : o.top, d = (n2 ? l.bottom : a) - o.bottom, c = e3.clientHeight + s2;
          return "bottom" === i3 ? d >= c : "top" === i3 ? r >= c : r >= c || d >= c;
        };
        ...
        class l extends o.default {
          constructor(e3, t3) {
            ...
            const i3 = this.el.dataset.hsInputNumber, s2 = i3 ? JSON.parse(i3) : { step: 1 }, n2 = Object.assign(Object.assign({}, s2), t3);
        ...
        class o extends n.default {
          constructor(e3, t3, i3) {
            var s2;
            super(e3, t3, i3);
            const n2 = e3.getAttribute("data-hs-range-slider"), o2 = n2 ? JSON.parse(n2) : {};
            this.concatOptions = Object.assign(Object.assign(Object.assign({}, o2), t3), { cssClasses: Object.assign(Object.assign({}, noUiSlider.cssClasses), this.processClasses(o2.cssClasses)) }), this.wrapper = this.concatOptions.wrapper || e3.closest(".hs-range-slider-wrapper") || null, this.currentValue = this.concatOptions.currentValue ? Array.from(this.concatOptions.currentValue) : Array.from((null === (s2 = this.wrapper) || void 0 === s2 ? void 0 : s2.querySelectorAll(".hs-range-slider-current-value")) || []), this.icons = this.concatOptions.icons || {}, this.init();
          }
          get formattedValue() {
          ...
          init() {
            var e3, t3, i3, s2, n2, o2, l, a, r, d, c, h, u;
            this.createCollection(window.$hsRangeSliderCollection, this), ("object" == typeof (null === (e3 = this.concatOptions) || void 0 === e3 ? void 0 : e3.formatter) ? "thousandsSeparatorAndDecimalPoints" === (null === (i3 = null === (t3 = this.concatOptions) || void 0 === t3 ? void 0 : t3.formatter) || void 0 === i3 ? void 0 : i3.type) : "thousandsSeparatorAndDecimalPoints" === (null === (s2 = this.concatOptions) || void 0 === s2 ? void 0 : s2.formatter)) ? this.thousandsSeparatorAndDecimalPointsFormatter() : ("object" == typeof (null === (n2 = this.concatOptions) || void 0 === n2 ? void 0 : n2.formatter) ? "integer" === (null === (l = null === (o2 = this.concatOptions) || void 0 === o2 ? void 0 : o2.formatter) || void 0 === l ? void 0 : l.type) : "integer" === (null === (a = this.concatOptions) || void 0 === a ? void 0 : a.formatter)) ? this.integerFormatter() : "object" == typeof (null === (r = this.concatOptions) || void 0 === r ? void 0 : r.formatter) && ((null === (c = null === (d = this.concatOptions) || void 0 === d ? void 0 : d.formatter) || void 0 === c ? void 0 : c.prefix) || (null === (u = null === (h = this.concatOptions) || void 0 === h ? void 0 : h.formatter) || void 0 === u ? void 0 : u.postfix)) && this.prefixOrPostfixFormatter(), noUiSlider.create(this.el, this.concatOptions), this.currentValue && this.currentValue.length > 0 && this.el.noUiSlider.on("update", ((e4) => {
              this.updateCurrentValue(e4);
            })), this.concatOptions.disabled && this.setDisabled(), this.icons.handle && this.buildHandleIcon();
          }
          formatValue(e3) {
            var t3, i3, s2, n2, o2, l, a, r, d;
            let c = "";
            return "object" == typeof (null === (t3 = this.concatOptions) || void 0 === t3 ? void 0 : t3.formatter) ? ((null === (s2 = null === (i3 = this.concatOptions) || void 0 === i3 ? void 0 : i3.formatter) || void 0 === s2 ? void 0 : s2.prefix) && (c += null === (o2 = null === (n2 = this.concatOptions) || void 0 === n2 ? void 0 : n2.formatter) || void 0 === o2 ? void 0 : o2.prefix), c += e3, (null === (a = null === (l = this.concatOptions) || void 0 === l ? void 0 : l.formatter) || void 0 === a ? void 0 : a.postfix) && (c += null === (d = null === (r = this.concatOptions) || void 0 === r ? void 0 : r.formatter) || void 0 === d ? void 0 : d.postfix)) : c += e3, c;
          }
          integerFormatter() {
            var e3;
        ...
        !(function(e3) {
          "use strict";
          var t3 = Object.defineProperty, i2 = Object.defineProperties, s = Object.getOwnPropertyDescriptors, n = Object.getOwnPropertySymbols, o = Object.prototype.hasOwnProperty, l = Object.prototype.propertyIsEnumerable, a = (e4, i3, s2) => i3 in e4 ? t3(e4, i3, { enumerable: true, configurable: true, writable: true, value: s2 }) : e4[i3] = s2, r = (e4, t4) => {
            for (var i3 in t4 || (t4 = {})) o.call(t4, i3) && a(e4, i3, t4[i3]);
            if (n) for (var i3 of n(t4)) l.call(t4, i3) && a(e4, i3, t4[i3]);
            return e4;
          }, d = (e4, t4, i3) => (a(e4, "symbol" != typeof t4 ? t4 + "" : t4, i3), i3);
          const c = (e4) => `${e4} is not found, check the first argument passed to new Calendar.`, h = 'The calendar has not been initialized, please initialize it using the "init()" method first.', u = "You specified an incorrect language label or did not specify the required number of values ​​for «locale.weekdays» or «locale.months».", p = "The value of the time property can be: false, 12 or 24.", m = "For the «multiple» calendar type, the «displayMonthsCount» parameter can have a value from 2 to 12, and for all others it cannot be greater than 1.", g = (e4, t4, i3) => {
            e4.context[t4] = i3;
          }, v = (e4) => {
            e4.context.isShowInInputMode && e4.context.currentType && (e4.context.mainElement.dataset.vcCalendarHidden = "", g(e4, "isShowInInputMode", false), e4.context.cleanupHandlers[0] && (e4.context.cleanupHandlers.forEach(((e5) => e5())), g(e4, "cleanupHandlers", [])), e4.onHide && e4.onHide(e4));
          };
          function f(e4) {
          ...
          function w(e4) {
            const { top: t4, left: i3 } = { left: window.scrollX || document.documentElement.scrollLeft || 0, top: window.scrollY || document.documentElement.scrollTop || 0 }, { top: s2, left: n2 } = f(e4), { vh: o2, vw: l2 } = y(), a2 = s2 - t4, r2 = n2 - i3;
            return { top: a2, bottom: o2 - (a2 + e4.clientHeight), left: r2, right: l2 - (r2 + e4.clientWidth) };
          }
          function b(e4, t4, i3 = 5) {
            const s2 = { top: true, bottom: true, left: true, right: true }, n2 = [];
            if (!t4 || !e4) return { canShow: s2, parentPositions: n2 };
            const { bottom: o2, top: l2 } = w(e4), { top: a2, left: r2 } = f(e4), { height: d2, width: c2 } = t4.getBoundingClientRect(), { vh: h2, vw: u2 } = y(), p2 = u2 / 2, m2 = h2 / 2;
            return [{ condition: a2 < m2, position: "top" }, { condition: a2 > m2, position: "bottom" }, { condition: r2 < p2, position: "left" }, { condition: r2 > p2, position: "right" }].forEach((({ condition: e5, position: t5 }) => {
              e5 && n2.push(t5);
            })), Object.assign(s2, { top: d2 <= l2 - i3, bottom: d2 <= o2 - i3, left: c2 <= r2, right: c2 <= u2 - r2 }), { canShow: s2, parentPositions: n2 };
          }
          const C = (e4, t4) => {
            var i3;
            e4.popups && (null == (i3 = Object.entries(e4.popups)) || i3.forEach((([i4, s2]) => ((e5, t5, i5, s3) => {
              var n2;
              const o2 = s3.querySelector(`[data-vc-date="${t5}"]`), l2 = null == o2 ? void 0 : o2.querySelector("[data-vc-date-btn]");
              if (!o2 || !l2) return;
              if ((null == i5 ? void 0 : i5.modifier) && l2.classList.add(...i5.modifier.trim().split(" ")), !(null == i5 ? void 0 : i5.html)) return;
              const a2 = document.createElement("div");
              a2.className = e5.styles.datePopup, a2.dataset.vcDatePopup = "", a2.innerHTML = e5.sanitizerHTML(i5.html), l2.ariaExpanded = "true", l2.ariaLabel = `${l2.ariaLabel}, ${null == (n2 = null == a2 ? void 0 : a2.textContent) ? void 0 : n2.replace(/^\s+|\s+(?=\s)|\s+$/g, "").replace(/&nbsp;/g, " ")}`, o2.appendChild(a2), requestAnimationFrame((() => {
                if (!a2) return;
                const { canShow: e6 } = b(o2, a2), t6 = e6.bottom ? o2.offsetHeight : -a2.offsetHeight, i6 = e6.left && !e6.right ? o2.offsetWidth - a2.offsetWidth / 2 : !e6.left && e6.right ? a2.offsetWidth / 2 : 0;
                Object.assign(a2.style, { left: `${i6}px`, top: `${t6}px` });
              }));
            })(e4, i4, s2, t4))));
          }, S = (e4) => /* @__PURE__ */ new Date(`${e4}T00:00:00`), x = (e4) => `${e4.getFullYear()}-${String(e4.getMonth() + 1).padStart(2, "0")}-${String(e4.getDate()).padStart(2, "0")}`, L = (e4) => e4.reduce(((e5, t4) => {
            if (t4 instanceof Date || "number" == typeof t4) {
              const i3 = t4 instanceof Date ? t4 : new Date(t4);
              e5.push(i3.toISOString().substring(0, 10));
            } else t4.match(/^(\d{4}-\d{2}-\d{2})$/g) ? e5.push(t4) : t4.replace(/(\d{4}-\d{2}-\d{2}).*?(\d{4}-\d{2}-\d{2})/g, ((t5, i3, s2) => {
              const n2 = S(i3), o2 = S(s2), l2 = new Date(n2.getTime());
              for (; l2 <= o2; l2.setDate(l2.getDate() + 1)) e5.push(x(l2));
              return t5;
            }));
            return e5;
          }), []), E = (e4, t4, i3, s2 = "") => {
            t4 ? e4.setAttribute(i3, s2) : e4.getAttribute(i3) === s2 && e4.removeAttribute(i3);
          }, T = (e4, t4, i3, s2, n2, o2, l2) => {
            var a2, r2, d2, c2;
            const h2 = S(e4.context.displayDateMin) > S(o2) || S(e4.context.displayDateMax) < S(o2) || (null == (a2 = e4.context.disableDates) ? void 0 : a2.includes(o2)) || !e4.selectionMonthsMode && "current" !== l2 || !e4.selectionYearsMode && S(o2).getFullYear() !== t4;
            E(i3, h2, "data-vc-date-disabled"), s2 && E(s2, h2, "aria-disabled", "true"), s2 && E(s2, h2, "tabindex", "-1"), E(i3, !e4.disableToday && e4.context.dateToday === o2, "data-vc-date-today"), E(i3, !e4.disableToday && e4.context.dateToday === o2, "aria-current", "date"), E(i3, null == (r2 = e4.selectedWeekends) ? void 0 : r2.includes(n2), "data-vc-date-weekend");
            const u2 = (null == (d2 = e4.selectedHolidays) ? void 0 : d2[0]) ? L(e4.selectedHolidays) : [];
            if (E(i3, u2.includes(o2), "data-vc-date-holiday"), (null == (c2 = e4.context.selectedDates) ? void 0 : c2.includes(o2)) ? (i3.setAttribute("data-vc-date-selected", ""), s2 && s2.setAttribute("aria-selected", "true"), e4.context.selectedDates.length > 1 && "multiple-ranged" === e4.selectionDatesMode && (e4.context.selectedDates[0] === o2 && e4.context.selectedDates[e4.context.selectedDates.length - 1] === o2 ? i3.setAttribute("data-vc-date-selected", "first-and-last") : e4.context.selectedDates[0] === o2 ? i3.setAttribute("data-vc-date-selected", "first") : e4.context.selectedDates[e4.context.selectedDates.length - 1] === o2 && i3.setAttribute("data-vc-date-selected", "last"), e4.context.selectedDates[0] !== o2 && e4.context.selectedDates[e4.context.selectedDates.length - 1] !== o2 && i3.setAttribute("data-vc-date-selected", "middle"))) : i3.hasAttribute("data-vc-date-selected") && (i3.removeAttribute("data-vc-date-selected"), s2 && s2.removeAttribute("aria-selected")), !e4.context.disableDates.includes(o2) && e4.enableEdgeDatesOnly && e4.context.selectedDates.length > 1 && "multiple-ranged" === e4.selectionDatesMode) {
              const t5 = S(e4.context.selectedDates[0]), s3 = S(e4.context.selectedDates[e4.context.selectedDates.length - 1]), n3 = S(o2);
              E(i3, n3 > t5 && n3 < s3, "data-vc-date-selected", "middle");
            }
          }, k = (e4, t4) => {
            const i3 = S(e4), s2 = (i3.getDay() - t4 + 7) % 7;
            i3.setDate(i3.getDate() + 4 - s2);
            const n2 = new Date(i3.getFullYear(), 0, 1), o2 = Math.ceil(((+i3 - +n2) / 864e5 + 1) / 7);
            return { year: i3.getFullYear(), week: o2 };
          }, I = (e4, t4, i3, s2, n2, o2) => {
            const l2 = S(n2).getDay(), a2 = "string" == typeof e4.locale && e4.locale.length ? e4.locale : "en", r2 = document.createElement("div");
            let d2;
            r2.className = e4.styles.date, r2.dataset.vcDate = n2, r2.dataset.vcDateMonth = o2, r2.dataset.vcDateWeekDay = String(l2), ("current" === o2 || e4.displayDatesOutside) && (d2 = document.createElement("button"), d2.className = e4.styles.dateBtn, d2.type = "button", d2.role = "gridcell", d2.ariaLabel = ((e5, t5, i4) => (/* @__PURE__ */ new Date(`${e5}T00:00:00.000Z`)).toLocaleString(t5, i4))(n2, a2, { dateStyle: "long", timeZone: "UTC" }), d2.dataset.vcDateBtn = "", d2.innerText = String(s2), r2.appendChild(d2)), e4.enableWeekNumbers && ((e5, t5, i4) => {
              const s3 = k(i4, e5.firstWeekday);
              s3 && (t5.dataset.vcDateWeekNumber = String(s3.week));
            })(e4, r2, n2), ((e5, t5, i4) => {
              var s3, n3, o3, l3, a3;
              const r3 = null == (s3 = e5.disableWeekdays) ? void 0 : s3.includes(i4), d3 = e5.disableAllDates && !!(null == (n3 = e5.context.enableDates) ? void 0 : n3[0]);
              !r3 && !d3 || (null == (o3 = e5.context.enableDates) ? void 0 : o3.includes(t5)) || (null == (l3 = e5.context.disableDates) ? void 0 : l3.includes(t5)) || (e5.context.disableDates.push(t5), null == (a3 = e5.context.disableDates) || a3.sort(((e6, t6) => +new Date(e6) - +new Date(t6))));
            })(e4, n2, l2), T(e4, t4, r2, d2, l2, n2, o2), i3.appendChild(r2), e4.onCreateDateEls && e4.onCreateDateEls(e4, r2);
          }, A = (e4) => {
            const t4 = new Date(e4.context.selectedYear, e4.context.selectedMonth, 1), i3 = e4.context.mainElement.querySelectorAll('[data-vc="dates"]'), s2 = e4.context.mainElement.querySelectorAll('[data-vc-week="numbers"]');
            i3.forEach(((i4, n2) => {
              e4.selectionDatesMode || (i4.dataset.vcDatesDisabled = ""), i4.textContent = "";
              const o2 = new Date(t4);
              o2.setMonth(o2.getMonth() + n2);
              const l2 = o2.getMonth(), a2 = o2.getFullYear(), r2 = (new Date(a2, l2, 1).getDay() - e4.firstWeekday + 7) % 7, d2 = new Date(a2, l2 + 1, 0).getDate();
              ((e5, t5, i5, s3, n3) => {
                let o3 = new Date(i5, s3, 0).getDate() - (n3 - 1);
                const l3 = 0 === s3 ? i5 - 1 : i5, a3 = 0 === s3 ? 12 : s3 < 10 ? `0${s3}` : s3;
                for (let s4 = n3; s4 > 0; s4--, o3++) I(e5, i5, t5, o3, `${l3}-${a3}-${o3}`, "prev");
              })(e4, i4, a2, l2, r2), ((e5, t5, i5, s3, n3) => {
                for (let o3 = 1; o3 <= i5; o3++) {
                  const i6 = new Date(s3, n3, o3);
                  I(e5, s3, t5, o3, x(i6), "current");
                }
              })(e4, i4, d2, a2, l2), ((e5, t5, i5, s3, n3, o3) => {
                const l3 = o3 + i5, a3 = 7 * Math.ceil(l3 / 7) - l3, r3 = n3 + 1 === 12 ? s3 + 1 : s3, d3 = n3 + 1 === 12 ? "01" : n3 + 2 < 10 ? `0${n3 + 2}` : n3 + 2;
                for (let i6 = 1; i6 <= a3; i6++) {
                  const n4 = i6 < 10 ? `0${i6}` : String(i6);
                  I(e5, s3, t5, i6, `${r3}-${d3}-${n4}`, "next");
                }
              })(e4, i4, d2, a2, l2, r2), C(e4, i4), ((e5, t5, i5, s3, n3) => {
                if (!e5.enableWeekNumbers) return;
                s3.textContent = "";
                const o3 = document.createElement("b");
                o3.className = e5.styles.weekNumbersTitle, o3.innerText = "#", o3.dataset.vcWeekNumbers = "title", s3.appendChild(o3);
                const l3 = document.createElement("div");
                l3.className = e5.styles.weekNumbersContent, l3.dataset.vcWeekNumbers = "content", s3.appendChild(l3);
                const a3 = document.createElement("button");
                a3.type = "button", a3.className = e5.styles.weekNumber;
                const r3 = n3.querySelectorAll("[data-vc-date]"), d3 = Math.ceil((t5 + i5) / 7);
                for (let t6 = 0; t6 < d3; t6++) {
                  const i6 = r3[0 === t6 ? 6 : 7 * t6].dataset.vcDate, s4 = k(i6, e5.firstWeekday);
                  if (!s4) return;
                  const n4 = a3.cloneNode(true);
                  n4.innerText = String(s4.week), n4.dataset.vcWeekNumber = String(s4.week), n4.dataset.vcWeekYear = String(s4.year), n4.role = "rowheader", n4.ariaLabel = `${s4.week}`, l3.appendChild(n4);
                }
              })(e4, r2, d2, s2[n2], i4);
            }));
          }, M = (e4) => `
...
`, $ = { ArrowNext: (e4, t4) => `<button type="button" class="${e4.styles.arrowNext}" data-vc-arrow="next" aria-label="${e4.labels.arrowNext[t4]}"></button>`, ArrowPrev: (e4, t4) => `<button type="button" class="${e4.styles.arrowPrev}" data-vc-arrow="prev" aria-label="${e4.labels.arrowPrev[t4]}"></button>`, ControlTime: (e4) => e4.selectionTimeMode ? `<div class="${e4.styles.time}" data-vc="time" role="group" aria-label="${e4.labels.selectingTime}"></div>` : "", Dates: (e4) => `<div class="${e4.styles.dates}" data-vc="dates" role="grid" aria-live="assertive" aria-label="${e4.labels.dates}" ${"multiple" === e4.type ? "aria-multiselectable" : ""}></div>`, DateRangeTooltip: (e4) => e4.onCreateDateRangeTooltip ? `<div class="${e4.styles.dateRangeTooltip}" data-vc-date-range-tooltip="hidden"></div>` : "", Month: (e4) => `<button type="button" class="${e4.styles.month}" data-vc="month"></button>`, Months: (e4) => `<div class="${e4.styles.months}" data-vc="months" role="grid" aria-live="assertive" aria-label="${e4.labels.months}"></div>`, Week: (e4) => `<div class="${e4.styles.week}" data-vc="week" role="row" aria-label="${e4.labels.week}"></div>`, WeekNumbers: (e4) => e4.enableWeekNumbers ? `<div class="${e4.styles.weekNumbers}" data-vc-week="numbers" role="row" aria-label="${e4.labels.weekNumber}"></div>` : "", Year: (e4) => `<button type="button" class="${e4.styles.year}" data-vc="year"></button>`, Years: (e4) => `<div class="${e4.styles.years}" data-vc="years" role="grid" aria-live="assertive" aria-label="${e4.labels.years}"></div>` }, H = (e4, t4) => t4.replace(/[\n\t]/g, "").replace(/<#(?!\/?Multiple)(.*?)>/g, ((t5, i3) => {
            ...
            if (Object.keys(i3).forEach(((t5) => {
              ...
              if ("multiple" === e4.type && t4) {
                const i4 = e4.context.mainElement.querySelector('[data-vc="controls"]'), s2 = e4.context.mainElement.querySelector('[data-vc="grid"]'), n2 = t4.closest('[data-vc="column"]');
                return i4 && e4.context.mainElement.removeChild(i4), s2 && (s2.dataset.vcGrid = "hidden"), n2 && (n2.dataset.vcColumn = e4.context.currentType), void (n2 && (n2.innerHTML = e4.sanitizerHTML(H(e4, e4.layouts[e4.context.currentType]))));
              }
              e4.context.mainElement.innerHTML = e4.sanitizerHTML(H(e4, e4.layouts[e4.context.currentType]));
            } else e4.context.mainElement.innerHTML = e4.sanitizerHTML(((e5, t5) => t5.replace(new RegExp("<#Multiple>(.*?)<#\\/Multiple>", "gs"), ((t6, i4) => {
              const s2 = Array(e5.context.displayMonthsCount).fill(i4).join("");
              return e5.sanitizerHTML(s2);
            })).replace(/[\n\t]/g, ""))(e4, H(e4, e4.layouts[e4.context.currentType])));
          }, B = (e4, t4, i3, s2) => {
            e4.style.visibility = i3 ? "hidden" : "", t4.style.visibility = s2 ? "hidden" : "";
          }, q = (e4) => {
            ...
            if (!t4 || !i3) return;
            const s2 = { default: () => ((e5, t5, i4) => {
              const s3 = S(x(new Date(e5.context.selectedYear, e5.context.selectedMonth, 1))), n2 = new Date(s3.getTime()), o2 = new Date(s3.getTime());
              n2.setMonth(n2.getMonth() - e5.monthsToSwitch), o2.setMonth(o2.getMonth() + e5.monthsToSwitch);
              const l2 = S(e5.context.dateMin), a2 = S(e5.context.dateMax);
              e5.selectionYearsMode || (l2.setFullYear(s3.getFullYear()), a2.setFullYear(s3.getFullYear()));
              const r2 = !e5.selectionMonthsMode || n2.getFullYear() < l2.getFullYear() || n2.getFullYear() === l2.getFullYear() && n2.getMonth() < l2.getMonth(), d2 = !e5.selectionMonthsMode || o2.getFullYear() > a2.getFullYear() || o2.getFullYear() === a2.getFullYear() && o2.getMonth() > a2.getMonth() - (e5.context.displayMonthsCount - 1);
              B(t5, i4, r2, d2);
            })(e4, t4, i3), year: () => ((e5, t5, i4) => {
              const s3 = S(e5.context.dateMin), n2 = S(e5.context.dateMax), o2 = !!(s3.getFullYear() && e5.context.displayYear - 7 <= s3.getFullYear()), l2 = !!(n2.getFullYear() && e5.context.displayYear + 7 >= n2.getFullYear());
              B(t5, i4, o2, l2);
            })(e4, t4, i3) };
            s2["multiple" === e4.context.currentType ? "default" : e4.context.currentType]();
          }, F = (e4) => {
            const t4 = e4.context.mainElement.querySelectorAll('[data-vc="month"]'), i3 = e4.context.mainElement.querySelectorAll('[data-vc="year"]'), s2 = new Date(e4.context.selectedYear, e4.context.selectedMonth, 1);
            [t4, i3].forEach(((t5) => null == t5 ? void 0 : t5.forEach(((t6, i4) => ((e5, t7, i5, s3, n2) => {
              const o2 = new Date(s3.setFullYear(e5.context.selectedYear, e5.context.selectedMonth + i5)).getFullYear(), l2 = new Date(s3.setMonth(e5.context.selectedMonth + i5)).getMonth(), a2 = e5.context.locale.months.long[l2], r2 = t7.closest('[data-vc="column"]');
              r2 && (r2.ariaLabel = `${a2} ${o2}`);
              const d2 = { month: { id: l2, label: a2 }, year: { id: o2, label: o2 } };
              t7.innerText = String(d2[n2].label), t7.dataset[`vc${n2.charAt(0).toUpperCase() + n2.slice(1)}`] = String(d2[n2].id), t7.ariaLabel = `${e5.labels[n2]} ${d2[n2].label}`;
              const c2 = { month: e5.selectionMonthsMode, year: e5.selectionYearsMode }, h2 = false === c2[n2] || "only-arrows" === c2[n2];
              h2 && (t7.tabIndex = -1), t7.disabled = h2;
            })(e4, t6, i4, s2, t6.dataset.vc)))));
          }, _2 = (e4, t4, i3, s2, n2) => {
            var o2;
            ...
            n2 && (null == (o2 = e4.context.mainElement.querySelectorAll(l2[i3])) || o2.forEach(((e5) => {
              e5.removeAttribute(a2[i3].selected), e5.removeAttribute(a2[i3].aria);
            })), g(e4, a2[i3].selectedProperty, Number(t4.dataset[a2[i3].value])), F(e4), "year" === i3 && q(e4)), s2 && (t4.setAttribute(a2[i3].selected, ""), t4.setAttribute(a2[i3].aria, "true"));
          }, R = (e4, t4) => {
            var i3;
            if ("multiple" !== e4.type) return { currentValue: null, columnID: 0 };
            const s2 = e4.context.mainElement.querySelectorAll('[data-vc="column"]'), n2 = Array.from(s2).findIndex(((e5) => e5.closest(`[data-vc-column="${t4}"]`)));
            return { currentValue: n2 >= 0 ? Number(null == (i3 = s2[n2].querySelector(`[data-vc="${t4}"]`)) ? void 0 : i3.getAttribute(`data-vc-${t4}`)) : null, columnID: Math.max(n2, 0) };
          }, V = (e4, t4, i3, s2, n2, o2, l2) => {
            const a2 = t4.cloneNode(false);
            return a2.className = e4.styles.monthsMonth, a2.innerText = s2, a2.ariaLabel = n2, a2.role = "gridcell", a2.dataset.vcMonthsMonth = `${l2}`, o2 && (a2.ariaDisabled = "true"), o2 && (a2.tabIndex = -1), a2.disabled = o2, _2(e4, a2, "month", i3 === l2, false), a2;
          }, j = (e4, t4) => {
            var i3, s2;
            const n2 = null == (i3 = null == t4 ? void 0 : t4.closest('[data-vc="header"]')) ? void 0 : i3.querySelector('[data-vc="year"]'), o2 = n2 ? Number(n2.dataset.vcYear) : e4.context.selectedYear, l2 = (null == t4 ? void 0 : t4.dataset.vcMonth) ? Number(t4.dataset.vcMonth) : e4.context.selectedMonth;
            g(e4, "currentType", "month"), N(e4, t4), F(e4);
            const a2 = e4.context.mainElement.querySelector('[data-vc="months"]');
            if (!e4.selectionMonthsMode || !a2) return;
            const r2 = e4.monthsToSwitch > 1 ? e4.context.locale.months.long.map(((t5, i4) => l2 - e4.monthsToSwitch * i4)).concat(e4.context.locale.months.long.map(((t5, i4) => l2 + e4.monthsToSwitch * i4))).filter(((e5) => e5 >= 0 && e5 <= 12)) : Array.from(Array(12).keys()), d2 = document.createElement("button");
            d2.type = "button";
            for (let t5 = 0; t5 < 12; t5++) {
              const i4 = S(e4.context.dateMin), s3 = S(e4.context.dateMax), n3 = e4.context.displayMonthsCount - 1, { columnID: c2 } = R(e4, "month"), h2 = o2 <= i4.getFullYear() && t5 < i4.getMonth() + c2 || o2 >= s3.getFullYear() && t5 > s3.getMonth() - n3 + c2 || o2 > s3.getFullYear() || t5 !== l2 && !r2.includes(t5), u2 = V(e4, d2, l2, e4.context.locale.months.short[t5], e4.context.locale.months.long[t5], h2, t5);
              a2.appendChild(u2), e4.onCreateMonthEls && e4.onCreateMonthEls(e4, u2);
            }
            null == (s2 = e4.context.mainElement.querySelector("[data-vc-months-month]:not([disabled])")) || s2.focus();
          }, z = (e4, t4, i3, s2, n2) => `
  <label class="${t4}" data-vc-time-input="${e4}">
    <input type="text" name="${e4}" maxlength="2" aria-label="${i3[`input${e4.charAt(0).toUpperCase() + e4.slice(1)}`]}" value="${s2}" ${n2 ? "disabled" : ""}>
  </label>
`, W = (e4, t4, i3, s2, n2, o2, l2) => `
  <label class="${t4}" data-vc-time-range="${e4}">
    <input type="range" name="${e4}" min="${s2}" max="${n2}" step="${o2}" aria-label="${i3[`range${e4.charAt(0).toUpperCase() + e4.slice(1)}`]}" value="${l2}">
  </label>
`, U = (e4, t4, i3, s2) => {
            ({ hour: () => g(e4, "selectedHours", i3), minute: () => g(e4, "selectedMinutes", i3) })[s2](), g(e4, "selectedTime", `${e4.context.selectedHours}:${e4.context.selectedMinutes}${e4.context.selectedKeeping ? ` ${e4.context.selectedKeeping}` : ""}`), e4.onChangeTime && e4.onChangeTime(e4, t4, false), e4.inputMode && e4.context.inputElement && e4.context.mainElement && e4.onChangeToInput && e4.onChangeToInput(e4, t4);
          }, Y = (e4, t4) => {
            var i3;
          ...
          }, K = (e4) => ({ 0: "12", 13: "01", 14: "02", 15: "03", 16: "04", 17: "05", 18: "06", 19: "07", 20: "08", 21: "09", 22: "10", 23: "11" })[Number(e4)] || String(e4), J = (e4, t4, i3, s2) => {
            e4.value = i3, t4.value = s2;
          }, Q = (e4, t4, i3, s2, n2, o2, l2) => {
            const a2 = { hour: (a3, r3, d2) => {
              if (!e4.selectionTimeMode) return;
              const c2 = { 12: () => {
                if (!e4.context.selectedKeeping) return;
                const c3 = Number(Y(r3, e4.context.selectedKeeping));
                if (!(c3 <= o2 && c3 >= l2)) return J(i3, t4, e4.context.selectedHours, e4.context.selectedHours), void (e4.onChangeTime && e4.onChangeTime(e4, d2, true));
                J(i3, t4, K(r3), Y(r3, e4.context.selectedKeeping)), a3 > 12 && ((e5, t5, i4) => {
                  t5 && i4 && (g(e5, "selectedKeeping", i4), t5.innerText = i4);
                })(e4, s2, "PM"), U(e4, d2, K(r3), n2);
              }, 24: () => {
                if (!(a3 <= o2 && a3 >= l2)) return J(i3, t4, e4.context.selectedHours, e4.context.selectedHours), void (e4.onChangeTime && e4.onChangeTime(e4, d2, true));
                J(i3, t4, r3, r3), U(e4, d2, r3, n2);
              } };
              c2[e4.selectionTimeMode]();
            }, minute: (s3, a3, r3) => {
              if (!(s3 <= o2 && s3 >= l2)) return i3.value = e4.context.selectedMinutes, void (e4.onChangeTime && e4.onChangeTime(e4, r3, true));
              i3.value = a3, t4.value = a3, U(e4, r3, a3, n2);
            } }, r2 = (e5) => {
              const t5 = Number(i3.value), s3 = i3.value.padStart(2, "0");
              a2[n2] && a2[n2](t5, s3, e5);
            };
            ...
            const o2 = (o3) => {
              const l2 = Number(t4.value), a2 = t4.value.padStart(2, "0"), r2 = "hour" === n2, d2 = 24 === e4.selectionTimeMode, c2 = l2 > 0 && l2 < 12;
              r2 && !d2 && ((e5, t5, i4) => {
                t5 && (g(e5, "selectedKeeping", i4), t5.innerText = i4);
              })(e4, s2, 0 === l2 || c2 ? "AM" : "PM"), ((e5, t5, i4, s3, n3) => {
                t5.value = n3, U(e5, i4, n3, s3);
              })(e4, i3, o3, n2, !r2 || d2 || c2 ? a2 : K(t4.value));
            };
            return t4.addEventListener("input", o2), () => {
              t4.removeEventListener("input", o2);
            };
          }, G = (e4) => e4.setAttribute("data-vc-input-focus", ""), X = (e4) => e4.removeAttribute("data-vc-input-focus"), ee = (e4, t4) => {
            const i3 = t4.querySelector('[data-vc-time-range="hour"] input[name="hour"]'), s2 = t4.querySelector('[data-vc-time-range="minute"] input[name="minute"]'), n2 = t4.querySelector('[data-vc-time-input="hour"] input[name="hour"]'), o2 = t4.querySelector('[data-vc-time-input="minute"] input[name="minute"]'), l2 = t4.querySelector('[data-vc-time="keeping"]');
            if (!(i3 && s2 && n2 && o2)) return;
            const a2 = (e5) => {
              e5.target === i3 && G(n2), e5.target === s2 && G(o2);
            }, r2 = (e5) => {
              e5.target === i3 && X(n2), e5.target === s2 && X(o2);
            };
            return t4.addEventListener("mouseover", a2), t4.addEventListener("mouseout", r2), Q(e4, i3, n2, l2, "hour", e4.timeMaxHour, e4.timeMinHour), Q(e4, s2, o2, l2, "minute", e4.timeMaxMinute, e4.timeMinMinute), Z(e4, i3, n2, l2, "hour"), Z(e4, s2, o2, l2, "minute"), l2 && ((e5, t5, i4, s3, n3) => {
              const o3 = (o4) => {
                const l3 = "AM" === e5.context.selectedKeeping ? "PM" : "AM", a3 = Y(e5.context.selectedHours, l3);
                Number(a3) <= s3 && Number(a3) >= n3 ? (g(e5, "selectedKeeping", l3), i4.value = a3, U(e5, o4, e5.context.selectedHours, "hour"), t5.ariaLabel = `${e5.labels.btnKeeping} ${e5.context.selectedKeeping}`, t5.innerText = e5.context.selectedKeeping) : e5.onChangeTime && e5.onChangeTime(e5, o4, true);
              };
            ...
            const t4 = e4.selectedWeekends ? [...e4.selectedWeekends] : [], i3 = [...e4.context.locale.weekdays.long].reduce(((i4, s3, n2) => [...i4, { id: n2, titleShort: e4.context.locale.weekdays.short[n2], titleLong: s3, isWeekend: t4.includes(n2) }]), []), s2 = [...i3.slice(e4.firstWeekday), ...i3.slice(0, e4.firstWeekday)];
            e4.context.mainElement.querySelectorAll('[data-vc="week"]').forEach(((t5) => {
              ...
              e4.onClickWeekDay && (i4.type = "button"), s2.forEach(((s3) => {
                const n2 = i4.cloneNode(true);
                n2.innerText = s3.titleShort, n2.className = e4.styles.weekDay, n2.role = "columnheader", n2.ariaLabel = s3.titleLong, n2.dataset.vcWeekDay = String(s3.id), s3.isWeekend && (n2.dataset.vcWeekDayOff = ""), t5.appendChild(n2);
              }));
            }));
          }, ie = (e4, t4, i3, s2, n2) => {
            const o2 = t4.cloneNode(false);
            return o2.className = e4.styles.yearsYear, o2.innerText = String(n2), o2.ariaLabel = String(n2), o2.role = "gridcell", o2.dataset.vcYearsYear = `${n2}`, s2 && (o2.ariaDisabled = "true"), s2 && (o2.tabIndex = -1), o2.disabled = s2, _2(e4, o2, "year", i3 === n2, false), o2;
          }, se = (e4, t4) => {
            var i3;
            const s2 = (null == t4 ? void 0 : t4.dataset.vcYear) ? Number(t4.dataset.vcYear) : e4.context.selectedYear;
            g(e4, "currentType", "year"), N(e4, t4), F(e4), q(e4);
            const n2 = e4.context.mainElement.querySelector('[data-vc="years"]');
            if (!e4.selectionYearsMode || !n2) return;
            const o2 = "multiple" !== e4.type || e4.context.selectedYear === s2 ? 0 : 1, l2 = document.createElement("button");
            l2.type = "button";
            for (let t5 = e4.context.displayYear - 7; t5 < e4.context.displayYear + 8; t5++) {
              const i4 = t5 < S(e4.context.dateMin).getFullYear() + o2 || t5 > S(e4.context.dateMax).getFullYear(), a2 = ie(e4, l2, s2, i4, t5);
              n2.appendChild(a2), e4.onCreateYearEls && e4.onCreateYearEls(e4, a2);
            }
            null == (i3 = e4.context.mainElement.querySelector("[data-vc-years-year]:not([disabled])")) || i3.focus();
          }, ne = { value: false, set: () => ne.value = true, check: () => ne.value }, oe = (e4, t4) => e4.dataset.vcTheme = t4, le = (e4, t4) => {
            if (oe(e4.context.mainElement, t4.matches ? "dark" : "light"), "system" !== e4.selectedTheme || ne.check()) return;
            const i3 = (e5) => {
              const t5 = document.querySelectorAll('[data-vc="calendar"]');
              null == t5 || t5.forEach(((t6) => oe(t6, e5.matches ? "dark" : "light")));
            };
            t4.addEventListener ? t4.addEventListener("change", i3) : t4.addListener(i3), ne.set();
          }, ae = (e4, t4) => {
            const i3 = e4.themeAttrDetect.length ? document.querySelector(e4.themeAttrDetect) : null, s2 = e4.themeAttrDetect.replace(/^.*\[(.+)\]/g, ((e5, t5) => t5));
            if (!i3 || "system" === i3.getAttribute(s2)) return void le(e4, t4);
            const n2 = i3.getAttribute(s2);
            n2 ? (oe(e4.context.mainElement, n2), ((e5, t5, i4) => {
              new MutationObserver(((e6) => {
                for (let s3 = 0; s3 < e6.length; s3++) if (e6[s3].attributeName === t5) {
                  i4();
                  break;
                }
              })).observe(e5, { attributes: true });
            })(i3, s2, (() => {
              const t5 = i3.getAttribute(s2);
              t5 && oe(e4.context.mainElement, t5);
            }))) : le(e4, t4);
          }, re = (e4) => e4.charAt(0).toUpperCase() + e4.slice(1).replace(/\./, ""), de = (e4) => {
            var t4, i3, s2, n2, o2, l2, a2, d2;
            if (!(e4.context.locale.weekdays.short[6] && e4.context.locale.weekdays.long[6] && e4.context.locale.months.short[11] && e4.context.locale.months.long[11])) if ("string" == typeof e4.locale) {
              ...
              Array.from({ length: 7 }, ((t5, i4) => ((e5, t6, i5) => {
                const s3 = /* @__PURE__ */ new Date(`1978-01-0${t6 + 1}T00:00:00.000Z`), n3 = s3.toLocaleString(i5, { weekday: "short", timeZone: "UTC" }), o3 = s3.toLocaleString(i5, { weekday: "long", timeZone: "UTC" });
                e5.context.locale.weekdays.short.push(re(n3)), e5.context.locale.weekdays.long.push(re(o3));
              })(e4, i4, e4.locale))), Array.from({ length: 12 }, ((t5, i4) => ((e5, t6, i5) => {
                const s3 = /* @__PURE__ */ new Date(`1978-${String(t6 + 1).padStart(2, "0")}-01T00:00:00.000Z`), n3 = s3.toLocaleString(i5, { month: "short", timeZone: "UTC" }), o3 = s3.toLocaleString(i5, { month: "long", timeZone: "UTC" });
                e5.context.locale.months.short.push(re(n3)), e5.context.locale.months.long.push(re(o3));
              })(e4, i4, e4.locale)));
            } else {
              if (!((null == (i3 = null == (t4 = e4.locale) ? void 0 : t4.weekdays) ? void 0 : i3.short[6]) && (null == (n2 = null == (s2 = e4.locale) ? void 0 : s2.weekdays) ? void 0 : n2.long[6]) && (null == (l2 = null == (o2 = e4.locale) ? void 0 : o2.months) ? void 0 : l2.short[11]) && (null == (d2 = null == (a2 = e4.locale) ? void 0 : a2.months) ? void 0 : d2.long[11]))) throw new Error(u);
            ...
            const t4 = { default: () => {
              ...
              te(e4), A(e4);
            }, month: () => j(e4), year: () => se(e4) };
            ((e5) => {
              "not all" !== window.matchMedia("(prefers-color-scheme)").media ? "system" === e5.selectedTheme ? ae(e5, window.matchMedia("(prefers-color-scheme: dark)")) : oe(e5.context.mainElement, e5.selectedTheme) : oe(e5.context.mainElement, "light");
            })(e4), de(e4), N(e4), F(e4), q(e4), ((e5) => {
              const t5 = e5.context.mainElement.querySelector('[data-vc="time"]');
              if (!e5.selectionTimeMode || !t5) return;
              const [i3, s2] = [e5.timeMinHour, e5.timeMaxHour], [n2, o2] = [e5.timeMinMinute, e5.timeMaxMinute], l2 = e5.context.selectedKeeping ? Y(e5.context.selectedHours, e5.context.selectedKeeping) : e5.context.selectedHours, a2 = "range" === e5.timeControls;
              var r2;
    ...
    <div class="${e5.styles.timeRanges}" data-vc-time="ranges">
      ${W("hour", e5.styles.timeRange, e5.labels, i3, s2, e5.timeStepHour, l2)}
      ${W("minute", e5.styles.timeRange, e5.labels, n2, o2, e5.timeStepMinute, e5.context.selectedMinutes)}
    </div>
  `), ee(e5, t5);
            ...
            const t4 = (t5) => {
              var i3;
              const s2 = t5.target;
              if (!["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(t5.key) || "button" !== s2.localName) return;
              const n2 = Array.from(e4.context.mainElement.querySelectorAll('[data-vc="calendar"] button')), o2 = n2.indexOf(s2);
              if (-1 === o2) return;
              const l2 = (a2 = n2[o2]).hasAttribute("data-vc-date-btn") ? 7 : a2.hasAttribute("data-vc-months-month") ? 4 : a2.hasAttribute("data-vc-years-year") ? 5 : 1;
              var a2;
              const r2 = (0, { ArrowUp: () => Math.max(0, o2 - l2), ArrowDown: () => Math.min(n2.length - 1, o2 + l2), ArrowLeft: () => Math.max(0, o2 - 1), ArrowRight: () => Math.min(n2.length - 1, o2 + 1) }[t5.key])();
              null == (i3 = n2[r2]) || i3.focus();
            };
            return e4.context.mainElement.addEventListener("keydown", t4), () => e4.context.mainElement.removeEventListener("keydown", t4);
          }, ue = (e4, t4) => {
            const i3 = S(x(new Date(e4.context.selectedYear, e4.context.selectedMonth, 1)));
            ({ prev: () => i3.setMonth(i3.getMonth() - e4.monthsToSwitch), next: () => i3.setMonth(i3.getMonth() + e4.monthsToSwitch) })[t4](), g(e4, "selectedMonth", i3.getMonth()), g(e4, "selectedYear", i3.getFullYear()), F(e4), q(e4), A(e4);
          }, pe = (e4) => void 0 === e4.enableDateToggle || ("function" == typeof e4.enableDateToggle ? e4.enableDateToggle(e4) : e4.enableDateToggle), me = (e4, t4, i3) => {
            const s2 = t4.dataset.vcDate, n2 = t4.closest("[data-vc-date][data-vc-date-selected]"), o2 = pe(e4);
            if (n2 && !o2) return;
            const l2 = n2 ? e4.context.selectedDates.filter(((e5) => e5 !== s2)) : i3 ? [...e4.context.selectedDates, s2] : [s2];
            g(e4, "selectedDates", l2);
          }, ge = (e4, t4, i3) => {
            if (!t4) return;
            if (!i3) return t4.dataset.vcDateRangeTooltip = "hidden", void (t4.textContent = "");
            const s2 = e4.context.mainElement.getBoundingClientRect(), n2 = i3.getBoundingClientRect();
            t4.style.left = n2.left - s2.left + n2.width / 2 + "px", t4.style.top = n2.bottom - s2.top - n2.height + "px", t4.dataset.vcDateRangeTooltip = "visible", t4.innerHTML = e4.sanitizerHTML(e4.onCreateDateRangeTooltip(e4, i3, t4, n2, s2));
          }, ve = { self: null, lastDateEl: null, isHovering: false, rangeMin: void 0, rangeMax: void 0, tooltipEl: null, timeoutId: null }, fe = (e4, t4, i3) => {
            var s2, n2, o2;
            if (!(null == (n2 = null == (s2 = ve.self) ? void 0 : s2.context) ? void 0 : n2.selectedDates[0])) return;
            const l2 = x(e4);
            (null == (o2 = ve.self.context.disableDates) ? void 0 : o2.includes(l2)) || (ve.self.context.mainElement.querySelectorAll(`[data-vc-date="${l2}"]`).forEach(((e5) => e5.dataset.vcDateHover = "")), t4.forEach(((e5) => e5.dataset.vcDateHover = "first")), i3.forEach(((e5) => {
              "first" === e5.dataset.vcDateHover ? e5.dataset.vcDateHover = "first-and-last" : e5.dataset.vcDateHover = "last";
            })));
          }, ye = () => {
            var e4, t4;
            (null == (t4 = null == (e4 = ve.self) ? void 0 : e4.context) ? void 0 : t4.mainElement) && ve.self.context.mainElement.querySelectorAll("[data-vc-date-hover]").forEach(((e5) => e5.removeAttribute("data-vc-date-hover")));
          }, we = (e4) => (t4) => {
            const i3 = t4.target;
            ve.isHovering || (ve.isHovering = true, requestAnimationFrame((() => {
              e4(i3), ve.isHovering = false;
            })));
          }, be = we(((e4) => {
            var t4, i3;
            if (!e4 || !(null == (i3 = null == (t4 = ve.self) ? void 0 : t4.context) ? void 0 : i3.selectedDates[0])) return;
            if (!e4.closest('[data-vc="dates"]')) return ve.lastDateEl = null, ge(ve.self, ve.tooltipEl, null), void ye();
            const s2 = e4.closest("[data-vc-date]");
            if (!s2 || ve.lastDateEl === s2) return;
            ve.lastDateEl = s2, ge(ve.self, ve.tooltipEl, s2), ye();
            const n2 = s2.dataset.vcDate, o2 = S(ve.self.context.selectedDates[0]), l2 = S(n2), a2 = ve.self.context.mainElement.querySelectorAll(`[data-vc-date="${ve.self.context.selectedDates[0]}"]`), r2 = ve.self.context.mainElement.querySelectorAll(`[data-vc-date="${n2}"]`), [d2, c2] = o2 < l2 ? [a2, r2] : [r2, a2], [h2, u2] = o2 < l2 ? [o2, l2] : [l2, o2];
            for (let e5 = new Date(h2); e5 <= u2; e5.setDate(e5.getDate() + 1)) fe(e5, d2, c2);
          })), Ce = we(((e4) => {
            const t4 = null == e4 ? void 0 : e4.closest("[data-vc-date-selected]");
            if (!t4 && ve.lastDateEl) return ve.lastDateEl = null, void ge(ve.self, ve.tooltipEl, null);
            t4 && ve.lastDateEl !== t4 && (ve.lastDateEl = t4, ge(ve.self, ve.tooltipEl, t4));
          })), Se = (e4) => {
            ve.self && "Escape" === e4.key && (ve.lastDateEl = null, g(ve.self, "selectedDates", []), ve.self.context.mainElement.removeEventListener("mousemove", be), ve.self.context.mainElement.removeEventListener("keydown", Se), ge(ve.self, ve.tooltipEl, null), ye());
          }, xe = () => {
            null !== ve.timeoutId && clearTimeout(ve.timeoutId), ve.timeoutId = setTimeout((() => {
              ve.lastDateEl = null, ge(ve.self, ve.tooltipEl, null), ye();
            }), 50);
          }, Le = (e4, t4) => {
            ve.self = e4, ve.lastDateEl = t4, ye(), e4.disableDatesGaps && (ve.rangeMin = ve.rangeMin ? ve.rangeMin : e4.context.displayDateMin, ve.rangeMax = ve.rangeMax ? ve.rangeMax : e4.context.displayDateMax), e4.onCreateDateRangeTooltip && (ve.tooltipEl = e4.context.mainElement.querySelector("[data-vc-date-range-tooltip]"));
            const i3 = null == t4 ? void 0 : t4.dataset.vcDate;
            if (i3) {
              const t5 = 1 === e4.context.selectedDates.length && e4.context.selectedDates[0].includes(i3), s2 = t5 && !pe(e4) ? [i3, i3] : t5 && pe(e4) ? [] : e4.context.selectedDates.length > 1 ? [i3] : [...e4.context.selectedDates, i3];
              g(e4, "selectedDates", s2), e4.context.selectedDates.length > 1 && e4.context.selectedDates.sort(((e5, t6) => +new Date(e5) - +new Date(t6)));
            }
            ({ set: () => (e4.disableDatesGaps && (() => {
              var e5, t5, i4, s2;
              if (!(null == (i4 = null == (t5 = null == (e5 = ve.self) ? void 0 : e5.context) ? void 0 : t5.selectedDates) ? void 0 : i4[0]) || !(null == (s2 = ve.self.context.disableDates) ? void 0 : s2[0])) return;
              const n2 = S(ve.self.context.selectedDates[0]), [o2, l2] = ve.self.context.disableDates.map(((e6) => S(e6))).reduce((([e6, t6], i5) => [n2 >= i5 ? i5 : e6, n2 < i5 && null === t6 ? i5 : t6]), [null, null]);
              o2 && g(ve.self, "displayDateMin", x(new Date(o2.setDate(o2.getDate() + 1)))), l2 && g(ve.self, "displayDateMax", x(new Date(l2.setDate(l2.getDate() - 1)))), ve.self.disableDatesPast && !ve.self.disableAllDates && S(ve.self.context.displayDateMin) < S(ve.self.context.dateToday) && g(ve.self, "displayDateMin", ve.self.context.dateToday);
            })(), ge(ve.self, ve.tooltipEl, t4), ve.self.context.mainElement.removeEventListener("mousemove", Ce), ve.self.context.mainElement.removeEventListener("mouseleave", xe), ve.self.context.mainElement.removeEventListener("keydown", Se), ve.self.context.mainElement.addEventListener("mousemove", be), ve.self.context.mainElement.addEventListener("mouseleave", xe), ve.self.context.mainElement.addEventListener("keydown", Se), () => {
              ve.self.context.mainElement.removeEventListener("mousemove", be), ve.self.context.mainElement.removeEventListener("mouseleave", xe), ve.self.context.mainElement.removeEventListener("keydown", Se);
            }), reset: () => {
              const [i4, s2] = [e4.context.selectedDates[0], e4.context.selectedDates[e4.context.selectedDates.length - 1]], n2 = e4.context.selectedDates[0] !== e4.context.selectedDates[e4.context.selectedDates.length - 1], o2 = L([`${i4}:${s2}`]).filter(((t5) => !e4.context.disableDates.includes(t5))), l2 = n2 ? e4.enableEdgeDatesOnly ? [i4, s2] : o2 : [e4.context.selectedDates[0], e4.context.selectedDates[0]];
              if (g(e4, "selectedDates", l2), e4.disableDatesGaps && (g(e4, "displayDateMin", ve.rangeMin), g(e4, "displayDateMax", ve.rangeMax)), ve.self.context.mainElement.removeEventListener("mousemove", be), ve.self.context.mainElement.removeEventListener("mouseleave", xe), ve.self.context.mainElement.removeEventListener("keydown", Se), e4.onCreateDateRangeTooltip) return e4.context.selectedDates[0] || (ve.self.context.mainElement.removeEventListener("mousemove", Ce), ve.self.context.mainElement.removeEventListener("mouseleave", xe), ge(ve.self, ve.tooltipEl, null)), e4.context.selectedDates[0] && (ve.self.context.mainElement.addEventListener("mousemove", Ce), ve.self.context.mainElement.addEventListener("mouseleave", xe), ge(ve.self, ve.tooltipEl, t4)), () => {
                ve.self.context.mainElement.removeEventListener("mousemove", Ce), ve.self.context.mainElement.removeEventListener("mouseleave", xe);
              };
            } })[1 === e4.context.selectedDates.length ? "set" : "reset"]();
          }, Ee = (e4) => {
            e4.context.mainElement.querySelectorAll("[data-vc-date]").forEach(((t4) => {
              const i3 = t4.querySelector("[data-vc-date-btn]"), s2 = t4.dataset.vcDate, n2 = S(s2).getDay();
              T(e4, e4.context.selectedYear, t4, i3, n2, s2, "current");
            }));
          }, Te = ["month", "year"], ke = (e4, t4, i3) => {
            const { currentValue: s2, columnID: n2 } = R(e4, t4);
            return "month" === e4.context.currentType && n2 >= 0 ? i3 - n2 : "year" === e4.context.currentType && e4.context.selectedYear !== s2 ? i3 - 1 : i3;
          }, Ie = (e4, t4, i3, s2) => {
            var n2;
            const o2 = { year: () => {
              if ("multiple" === e4.type) return ((e5, t5) => {
                const i4 = ke(e5, "year", Number(t5.dataset.vcYearsYear)), s3 = S(e5.context.dateMin), n3 = S(e5.context.dateMax), o3 = e5.context.displayMonthsCount - 1, { columnID: l2 } = R(e5, "year"), a2 = e5.context.selectedMonth < s3.getMonth() && i4 <= s3.getFullYear(), r2 = e5.context.selectedMonth > n3.getMonth() - o3 + l2 && i4 >= n3.getFullYear(), d2 = i4 < s3.getFullYear(), c2 = i4 > n3.getFullYear(), h2 = a2 || d2 ? s3.getFullYear() : r2 || c2 ? n3.getFullYear() : i4, u2 = a2 || d2 ? s3.getMonth() : r2 || c2 ? n3.getMonth() - o3 + l2 : e5.context.selectedMonth;
                g(e5, "selectedYear", h2), g(e5, "selectedMonth", u2);
              })(e4, s2);
              g(e4, "selectedYear", Number(s2.dataset.vcYearsYear));
            }, month: () => {
              if ("multiple" === e4.type) return ((e5, t5) => {
                const i4 = t5.closest('[data-vc-column="month"]').querySelector('[data-vc="year"]'), s3 = ke(e5, "month", Number(t5.dataset.vcMonthsMonth)), n3 = Number(i4.dataset.vcYear), o3 = S(e5.context.dateMin), l2 = S(e5.context.dateMax), a2 = s3 < o3.getMonth() && n3 <= o3.getFullYear(), r2 = s3 > l2.getMonth() && n3 >= l2.getFullYear();
                g(e5, "selectedYear", n3), g(e5, "selectedMonth", a2 ? o3.getMonth() : r2 ? l2.getMonth() : s3);
              })(e4, s2);
              g(e4, "selectedMonth", Number(s2.dataset.vcMonthsMonth));
            } };
            o2[i3](), { year: () => {
              var i4;
            ...
            } }[i3](), e4.context.currentType !== e4.type ? (g(e4, "currentType", e4.type), ce(e4), null == (n2 = e4.context.mainElement.querySelector(`[data-vc="${i3}"]`)) || n2.focus()) : _2(e4, s2, i3, true, true);
          }, Ae = (e4, t4) => {
            const i3 = { month: e4.selectionMonthsMode, year: e4.selectionYearsMode };
            Te.forEach(((s2) => {
              i3[s2] && t4.target && ((e5, t5, i4) => {
                var s3;
                const n2 = t5.target, o2 = n2.closest(`[data-vc="${i4}"]`), l2 = { year: () => se(e5, n2), month: () => j(e5, n2) };
                if (o2 && e5.onClickTitle && e5.onClickTitle(e5, t5), o2 && e5.context.currentType !== i4) return l2[i4]();
                const a2 = n2.closest(`[data-vc-${i4}s-${i4}]`);
                if (a2) return Ie(e5, t5, i4, a2);
                const r2 = n2.closest('[data-vc="grid"]'), d2 = n2.closest('[data-vc="column"]');
                (e5.context.currentType === i4 && o2 || "multiple" === e5.type && e5.context.currentType === i4 && r2 && !d2) && (g(e5, "currentType", e5.type), ce(e5), null == (s3 = e5.context.mainElement.querySelector(`[data-vc="${i4}"]`)) || s3.focus());
              })(e4, t4, s2);
            }));
          }, Me = (e4) => {
            const t4 = (t5) => {
              ((e5, t6) => {
                ...
                if (i3) {
                  if (["default", "multiple"].includes(e5.context.currentType)) ue(e5, i3.dataset.vcArrow);
                  else if ("year" === e5.context.currentType && void 0 !== e5.context.displayYear) {
                    const s2 = { prev: -15, next: 15 }[i3.dataset.vcArrow];
                    g(e5, "displayYear", e5.context.displayYear + s2), se(e5, t6.target);
                  }
                  e5.onClickArrow && e5.onClickArrow(e5, t6);
                }
              })(e4, t5), ((e5, t6) => {
                if (!e5.onClickWeekDay) return;
                const i3 = t6.target.closest("[data-vc-week-day]"), s2 = t6.target.closest('[data-vc="column"]'), n2 = s2 ? s2.querySelectorAll("[data-vc-date-week-day]") : e5.context.mainElement.querySelectorAll("[data-vc-date-week-day]");
                if (!i3 || !n2[0]) return;
                const o2 = Number(i3.dataset.vcWeekDay), l2 = Array.from(n2).filter(((e6) => Number(e6.dataset.vcDateWeekDay) === o2));
                e5.onClickWeekDay(e5, o2, l2, t6);
              })(e4, t5), ((e5, t6) => {
                if (!e5.enableWeekNumbers || !e5.onClickWeekNumber) return;
                const i3 = t6.target.closest("[data-vc-week-number]"), s2 = e5.context.mainElement.querySelectorAll("[data-vc-date-week-number]");
                if (!i3 || !s2[0]) return;
                const n2 = Number(i3.innerText), o2 = Number(i3.dataset.vcWeekYear), l2 = Array.from(s2).filter(((e6) => Number(e6.dataset.vcDateWeekNumber) === n2));
                e5.onClickWeekNumber(e5, n2, o2, l2, t6);
              })(e4, t5), ((e5, t6) => {
                var i3;
                const s2 = t6.target, n2 = s2.closest("[data-vc-date-btn]");
                if (!e5.selectionDatesMode || !["single", "multiple", "multiple-ranged"].includes(e5.selectionDatesMode) || !n2) return;
                const o2 = n2.closest("[data-vc-date]");
                ({ single: () => me(e5, o2, false), multiple: () => me(e5, o2, true), "multiple-ranged": () => Le(e5, o2) })[e5.selectionDatesMode](), null == (i3 = e5.context.selectedDates) || i3.sort(((e6, t7) => +new Date(e6) - +new Date(t7))), e5.onClickDate && e5.onClickDate(e5, t6), e5.inputMode && e5.context.inputElement && e5.context.mainElement && e5.onChangeToInput && e5.onChangeToInput(e5, t6);
                const l2 = s2.closest('[data-vc-date-month="prev"]'), a2 = s2.closest('[data-vc-date-month="next"]');
                ({ prev: () => e5.enableMonthChangeOnDayClick ? ue(e5, "prev") : Ee(e5), next: () => e5.enableMonthChangeOnDayClick ? ue(e5, "next") : Ee(e5), current: () => Ee(e5) })[l2 ? "prev" : a2 ? "next" : "current"]();
              })(e4, t5), Ae(e4, t5);
            };
          ...
          })() : e4 instanceof Date || "number" == typeof e4 || "string" == typeof e4 ? L([e4])[0] : t4, De = (e4, t4, i3) => {
            g(e4, "selectedMonth", t4), g(e4, "selectedYear", i3), g(e4, "displayYear", i3);
          }, Pe = (e4) => {
            var t4;
            if (e4.enableJumpToSelectedDate && (null == (t4 = e4.selectedDates) ? void 0 : t4[0]) && void 0 === e4.selectedMonth && void 0 === e4.selectedYear) {
              const t5 = S(L(e4.selectedDates)[0]);
              return void De(e4, t5.getMonth(), t5.getFullYear());
            }
            if (((e5) => {
              const t5 = (t6) => {
                const i5 = new Date(t6);
                De(e5, i5.getMonth(), i5.getFullYear());
              };
              if (e5.displayDateMin && "today" !== e5.displayDateMin && (i4 = e5.displayDateMin, s3 = /* @__PURE__ */ new Date(), new Date(i4).getTime() > s3.getTime())) {
                const i5 = e5.selectedDates.length && e5.selectedDates[0] ? L(e5.selectedDates)[0] : e5.displayDateMin;
                return t5(S(Oe(i5, e5.displayDateMin))), true;
              }
              var i4, s3;
              if (e5.displayDateMax && "today" !== e5.displayDateMax && ((e6, t6) => new Date(e6).getTime() < t6.getTime())(e5.displayDateMax, /* @__PURE__ */ new Date())) {
                const i5 = e5.selectedDates.length && e5.selectedDates[0] ? L(e5.selectedDates)[0] : e5.displayDateMax;
                return t5(S(Oe(i5, e5.displayDateMax))), true;
              }
              return false;
            })(e4)) return;
            const i3 = void 0 !== e4.selectedMonth && Number(e4.selectedMonth) >= 0 && Number(e4.selectedMonth) < 12, s2 = void 0 !== e4.selectedYear && Number(e4.selectedYear) >= 0 && Number(e4.selectedYear) <= 9999;
            De(e4, i3 ? Number(e4.selectedMonth) : S(e4.context.dateToday).getMonth(), s2 ? Number(e4.selectedYear) : S(e4.context.dateToday).getFullYear());
          }, $e = (e4) => {
            g(e4, "currentType", e4.type), ((e5) => {
              ...
              var t4, i3, s2;
              const n2 = Oe(e5.dateMin, e5.dateMin), o2 = Oe(e5.dateMax, e5.dateMax), l2 = Oe(e5.displayDateMin, n2), a2 = Oe(e5.displayDateMax, o2);
              g(e5, "dateToday", Oe(e5.dateToday, e5.dateToday)), g(e5, "displayDateMin", l2 ? S(n2) >= S(l2) ? n2 : l2 : n2), g(e5, "displayDateMax", a2 ? S(o2) <= S(a2) ? o2 : a2 : o2);
              const r2 = e5.disableDatesPast && !e5.disableAllDates && S(l2) < S(e5.context.dateToday);
              g(e5, "displayDateMin", r2 || e5.disableAllDates ? e5.context.dateToday : l2), g(e5, "displayDateMax", e5.disableAllDates ? e5.context.dateToday : a2), g(e5, "disableDates", e5.disableDates[0] && !e5.disableAllDates ? L(e5.disableDates) : e5.disableAllDates ? [e5.context.displayDateMin] : []), e5.context.disableDates.length > 1 && e5.context.disableDates.sort(((e6, t5) => +new Date(e6) - +new Date(t5))), g(e5, "enableDates", e5.enableDates[0] ? L(e5.enableDates) : []), (null == (t4 = e5.context.enableDates) ? void 0 : t4[0]) && (null == (i3 = e5.context.disableDates) ? void 0 : i3[0]) && g(e5, "disableDates", e5.context.disableDates.filter(((t5) => !e5.context.enableDates.includes(t5)))), e5.context.enableDates.length > 1 && e5.context.enableDates.sort(((e6, t5) => +new Date(e6) - +new Date(t5))), (null == (s2 = e5.context.enableDates) ? void 0 : s2[0]) && e5.disableAllDates && (g(e5, "displayDateMin", e5.context.enableDates[0]), g(e5, "displayDateMax", e5.context.enableDates[e5.context.enableDates.length - 1])), g(e5, "dateMin", e5.displayDisabledDates ? n2 : e5.context.displayDateMin), g(e5, "dateMax", e5.displayDisabledDates ? o2 : e5.context.displayDateMax);
            })(e4), Pe(e4), ((e5) => {
              var t4;
              g(e5, "selectedDates", (null == (t4 = e5.selectedDates) ? void 0 : t4[0]) ? L(e5.selectedDates) : []);
            })(e4), ((e5) => {
              var t4, i3, s2;
              if (!e5.selectionTimeMode) return;
              if (![12, 24].includes(e5.selectionTimeMode)) throw new Error(p);
              const n2 = 12 === e5.selectionTimeMode, o2 = n2 ? /^(0[1-9]|1[0-2]):([0-5][0-9]) ?(AM|PM)?$/i : /^([0-1]?[0-9]|2[0-3]):([0-5][0-9])$/;
              let [l2, a2, r2] = null != (s2 = null == (i3 = null == (t4 = e5.selectedTime) ? void 0 : t4.match(o2)) ? void 0 : i3.slice(1)) ? s2 : [];
              l2 ? n2 && !r2 && (r2 = "AM") : (l2 = n2 ? K(String(e5.timeMinHour)) : String(e5.timeMinHour), a2 = String(e5.timeMinMinute), r2 = n2 ? Number(K(String(e5.timeMinHour))) >= 12 ? "PM" : "AM" : null), g(e5, "selectedHours", l2.padStart(2, "0")), g(e5, "selectedMinutes", a2.padStart(2, "0")), g(e5, "selectedKeeping", r2), g(e5, "selectedTime", `${e5.context.selectedHours}:${e5.context.selectedMinutes}${r2 ? ` ${r2}` : ""}`);
            })(e4);
          }, He = (e4, { year: t4, month: i3, dates: s2, time: n2, locale: o2 }, l2 = true) => {
            var a2;
            const r2 = { year: e4.selectedYear, month: e4.selectedMonth, dates: e4.selectedDates, time: e4.selectedTime };
            e4.selectedYear = t4 ? r2.year : e4.context.selectedYear, e4.selectedMonth = i3 ? r2.month : e4.context.selectedMonth, e4.selectedTime = n2 ? r2.time : e4.context.selectedTime, e4.selectedDates = "only-first" === s2 && (null == (a2 = e4.context.selectedDates) ? void 0 : a2[0]) ? [e4.context.selectedDates[0]] : true === s2 ? r2.dates : e4.context.selectedDates, o2 && g(e4, "locale", { months: { short: [], long: [] }, weekdays: { short: [], long: [] } }), $e(e4), l2 && ce(e4), e4.selectedYear = r2.year, e4.selectedMonth = r2.month, e4.selectedDates = r2.dates, e4.selectedTime = r2.time, "multiple-ranged" === e4.selectionDatesMode && s2 && Le(e4, null);
          }, Ne = (e4) => {
            g(e4, "inputElement", e4.context.mainElement);
            const t4 = () => {
              e4.context.inputModeInit ? setTimeout((() => _e(e4))) : ((e5) => {
                const t5 = document.createElement("div");
                t5.className = e5.styles.calendar, t5.dataset.vc = "calendar", t5.dataset.vcInput = "", t5.dataset.vcCalendarHidden = "", g(e5, "inputModeInit", true), g(e5, "isShowInInputMode", false), g(e5, "mainElement", t5), document.body.appendChild(e5.context.mainElement), He(e5, { year: true, month: true, dates: true, time: true, locale: true }), setTimeout((() => _e(e5))), e5.onInit && e5.onInit(e5), he(e5), Me(e5);
              })(e4);
            };
            return e4.context.inputElement.addEventListener("click", t4), e4.context.inputElement.addEventListener("focus", t4), () => {
              e4.context.inputElement.removeEventListener("click", t4), e4.context.inputElement.removeEventListener("focus", t4);
            };
          }, Be = (e4, t4) => {
            if (!e4.context.isInit) throw new Error(h);
            He(e4, r(r({}, { year: true, month: true, dates: true, time: true, locale: true }), t4), !(e4.inputMode && !e4.context.inputModeInit)), e4.onUpdate && e4.onUpdate(e4);
          }, qe = (e4, t4) => {
            const i3 = Object.keys(t4);
            for (let s2 = 0; s2 < i3.length; s2++) {
              const n2 = i3[s2];
              "object" != typeof e4[n2] || "object" != typeof t4[n2] || t4[n2] instanceof Date || Array.isArray(t4[n2]) ? void 0 !== t4[n2] && (e4[n2] = t4[n2]) : qe(e4[n2], t4[n2]);
            }
          }, Fe = (e4, t4, i3) => {
            if (!e4) return;
            const s2 = "auto" === i3 ? (function(e5, t5) {
              const i4 = "left";
              if (!t5 || !e5) return i4;
              const { canShow: s3, parentPositions: n3 } = b(e5, t5), o3 = s3.left && s3.right;
              return (o3 && s3.bottom ? "center" : o3 && s3.top ? ["top", "center"] : Array.isArray(n3) ? ["bottom" === n3[0] ? "top" : "bottom", ...n3.slice(1)] : n3) || i4;
            })(e4, t4) : i3, n2 = { top: -t4.offsetHeight, bottom: e4.offsetHeight, left: 0, center: e4.offsetWidth / 2 - t4.offsetWidth / 2, right: e4.offsetWidth - t4.offsetWidth }, o2 = Array.isArray(s2) ? s2[0] : "bottom", l2 = Array.isArray(s2) ? s2[1] : s2;
            t4.dataset.vcPosition = o2;
            const { top: a2, left: r2 } = f(e4), d2 = a2 + n2[o2];
            let c2 = r2 + n2[l2];
            const { vw: h2 } = y();
            if (c2 + t4.clientWidth > h2) {
              const e5 = window.innerWidth - document.body.clientWidth;
              c2 = h2 - t4.clientWidth - e5;
            } else c2 < 0 && (c2 = 0);
            Object.assign(t4.style, { left: `${c2}px`, top: `${d2}px` });
          }, _e = (e4) => {
            if (e4.context.isShowInInputMode) return;
            if (!e4.context.currentType) return void e4.context.mainElement.click();
            g(e4, "cleanupHandlers", []), g(e4, "isShowInInputMode", true), Fe(e4.context.inputElement, e4.context.mainElement, e4.positionToInput), e4.context.mainElement.removeAttribute("data-vc-calendar-hidden");
            const t4 = () => {
              Fe(e4.context.inputElement, e4.context.mainElement, e4.positionToInput);
            };
            window.addEventListener("resize", t4), e4.context.cleanupHandlers.push((() => window.removeEventListener("resize", t4)));
            const i3 = (t5) => {
              "Escape" === t5.key && v(e4);
            };
            document.addEventListener("keydown", i3), e4.context.cleanupHandlers.push((() => document.removeEventListener("keydown", i3)));
            const s2 = (t5) => {
              t5.target === e4.context.inputElement || e4.context.mainElement.contains(t5.target) || v(e4);
            };
            document.addEventListener("click", s2, { capture: true }), e4.context.cleanupHandlers.push((() => document.removeEventListener("click", s2, { capture: true }))), e4.onShow && e4.onShow(e4);
          }, Re = { application: "Calendar", navigation: "Calendar Navigation", arrowNext: { month: "Next month", year: "Next list of years" }, arrowPrev: { month: "Previous month", year: "Previous list of years" }, month: "Select month, current selected month:", months: "List of months", year: "Select year, current selected year:", years: "List of years", week: "Days of the week", weekNumber: "Numbers of weeks in a year", dates: "Dates in the current month", selectingTime: "Selecting a time ", inputHour: "Hours", inputMinute: "Minutes", rangeHour: "Slider for selecting hours", rangeMinute: "Slider for selecting minutes", btnKeeping: "Switch AM/PM, current position:" }, Ve = { calendar: "vc", controls: "vc-controls", grid: "vc-grid", column: "vc-column", header: "vc-header", headerContent: "vc-header__content", month: "vc-month", year: "vc-year", arrowPrev: "vc-arrow vc-arrow_prev", arrowNext: "vc-arrow vc-arrow_next", wrapper: "vc-wrapper", content: "vc-content", months: "vc-months", monthsMonth: "vc-months__month", years: "vc-years", yearsYear: "vc-years__year", week: "vc-week", weekDay: "vc-week__day", weekNumbers: "vc-week-numbers", weekNumbersTitle: "vc-week-numbers__title", weekNumbersContent: "vc-week-numbers__content", weekNumber: "vc-week-number", dates: "vc-dates", date: "vc-date", dateBtn: "vc-date__btn", datePopup: "vc-date__popup", dateRangeTooltip: "vc-date-range-tooltip", time: "vc-time", timeContent: "vc-time__content", timeHour: "vc-time__hour", timeMinute: "vc-time__minute", timeKeeping: "vc-time__keeping", timeRanges: "vc-time__ranges", timeRange: "vc-time__range" };
          class je {
            constructor() {
              d(this, "type", "default"), d(this, "inputMode", false), d(this, "positionToInput", "left"), d(this, "firstWeekday", 1), d(this, "monthsToSwitch", 1), d(this, "themeAttrDetect", "html[data-theme]"), d(this, "locale", "en"), d(this, "dateToday", "today"), d(this, "dateMin", "1970-01-01"), d(this, "dateMax", "2470-12-31"), d(this, "displayDateMin"), d(this, "displayDateMax"), d(this, "displayDatesOutside", true), d(this, "displayDisabledDates", false), d(this, "displayMonthsCount"), d(this, "disableDates", []), d(this, "disableAllDates", false), d(this, "disableDatesPast", false), d(this, "disableDatesGaps", false), d(this, "disableWeekdays", []), d(this, "disableToday", false), d(this, "enableDates", []), d(this, "enableEdgeDatesOnly", true), d(this, "enableDateToggle", true), d(this, "enableWeekNumbers", false), d(this, "enableMonthChangeOnDayClick", true), d(this, "enableJumpToSelectedDate", false), d(this, "selectionDatesMode", "single"), d(this, "selectionMonthsMode", true), d(this, "selectionYearsMode", true), d(this, "selectionTimeMode", false), d(this, "selectedDates", []), d(this, "selectedMonth"), d(this, "selectedYear"), d(this, "selectedHolidays", []), d(this, "selectedWeekends", [0, 6]), d(this, "selectedTime"), d(this, "selectedTheme", "system"), d(this, "timeMinHour", 0), d(this, "timeMaxHour", 23), d(this, "timeMinMinute", 0), d(this, "timeMaxMinute", 59), d(this, "timeControls", "all"), d(this, "timeStepHour", 1), d(this, "timeStepMinute", 1), d(this, "sanitizerHTML", ((e4) => e4)), d(this, "onClickDate"), d(this, "onClickWeekDay"), d(this, "onClickWeekNumber"), d(this, "onClickTitle"), d(this, "onClickMonth"), d(this, "onClickYear"), d(this, "onClickArrow"), d(this, "onChangeTime"), d(this, "onChangeToInput"), d(this, "onCreateDateRangeTooltip"), d(this, "onCreateDateEls"), d(this, "onCreateMonthEls"), d(this, "onCreateYearEls"), d(this, "onInit"), d(this, "onUpdate"), d(this, "onDestroy"), d(this, "onShow"), d(this, "onHide"), d(this, "popups", {}), d(this, "labels", r({}, Re)), d(this, "layouts", { default: "", multiple: "", month: "", year: "" }), d(this, "styles", r({}, Ve));
            }
          }
          const ze = class e4 extends je {
            constructor(t4, n2) {
              var o2, l2;
              super(), d(this, "init", (() => {
                return g(e5 = this, "originalElement", e5.context.mainElement.cloneNode(true)), g(e5, "isInit", true), e5.inputMode ? Ne(e5) : ($e(e5), ce(e5), e5.onInit && e5.onInit(e5), he(e5), Me(e5));
                var e5;
              })), d(this, "update", ((e5) => Be(this, e5))), d(this, "destroy", (() => ((e5) => {
                var t5, i3, s2, n3, o3;
                if (!e5.context.isInit) throw new Error(h);
                e5.inputMode ? (null == (t5 = e5.context.mainElement.parentElement) || t5.removeChild(e5.context.mainElement), null == (s2 = null == (i3 = e5.context.inputElement) ? void 0 : i3.replaceWith) || s2.call(i3, e5.context.originalElement), g(e5, "inputElement", void 0)) : null == (o3 = (n3 = e5.context.mainElement).replaceWith) || o3.call(n3, e5.context.originalElement), g(e5, "mainElement", e5.context.originalElement), e5.onDestroy && e5.onDestroy(e5);
              })(this))), d(this, "show", (() => _e(this))), d(this, "hide", (() => v(this))), d(this, "set", ((e5, t5) => ((e6, t6, i3) => {
                qe(e6, t6), e6.context.isInit && Be(e6, i3);
              })(this, e5, t5))), d(this, "context"), this.context = (l2 = r({}, this.context), i2(l2, s({ locale: { months: { short: [], long: [] }, weekdays: { short: [], long: [] } } }))), g(this, "mainElement", "string" == typeof t4 ? null != (o2 = e4.memoizedElements.get(t4)) ? o2 : this.queryAndMemoize(t4) : t4), n2 && qe(this, n2);
            }
            queryAndMemoize(t4) {
              const i3 = document.querySelector(t4);
              if (!i3) throw new Error(c(t4));
              return e4.memoizedElements.set(t4, i3), i3;
            }
          };
          d(ze, "memoizedElements", /* @__PURE__ */ new Map());
          let We = ze;
          e3.Calendar = We, Object.defineProperty(e3, Symbol.toStringTag, { value: "Module" });
        })(t2);
        ...
        class l extends o.default {
          ...
          copy() {
            ...
            this.addToItems(e3), this.limit && this.items.length >= this.limit && this.el.setAttribute("disabled", "disabled"), this.fireEvent("copy", e3), (0, n.dispatch)("copy.hs.copyMarkup", e3, e3);
          }
          addPredefinedItems() {
          ...
          delete(e3) {
            ...
            -1 !== t3 && this.items.splice(t3, 1), e3.remove(), this.limit && this.items.length < this.limit && this.el.removeAttribute("disabled"), this.fireEvent("delete", e3), (0, n.dispatch)("delete.hs.copyMarkup", e3, e3);
          }
          destroy() {
        ...
        class d extends l.default {
          ...
          buildTagsItem(e3) {
            var t3, i3, s2, n2, l2;
            const a2 = this.getItemByValue(e3);
            let r2, d2, c, h;
            const u = document.createElement("div");
            if (u.setAttribute("data-tag-value", e3), this.tagsItemClasses && (0, o.classToClassList)(this.tagsItemClasses, u), this.tagsItemTemplate && (r2 = (0, o.htmlToElement)(this.tagsItemTemplate), u.append(r2)), (null === (t3 = null == a2 ? void 0 : a2.options) || void 0 === t3 ? void 0 : t3.icon) || this.apiIconTag) {
              const e4 = (0, o.htmlToElement)(this.apiUrl && this.apiIconTag ? this.apiIconTag : null === (i3 = null == a2 ? void 0 : a2.options) || void 0 === i3 ? void 0 : i3.icon);
              this.apiUrl && this.apiIconTag && a2[this.apiFieldsMap.icon] && (e4.src = a2[this.apiFieldsMap.icon] || ""), h = r2 ? r2.querySelector("[data-icon]") : document.createElement("span"), h.append(e4), r2 || u.append(h);
            }
            !r2 || !r2.querySelector("[data-icon]") || (null === (s2 = null == a2 ? void 0 : a2.options) || void 0 === s2 ? void 0 : s2.icon) || this.apiUrl || this.apiIconTag || a2[null === (n2 = this.apiFieldsMap) || void 0 === n2 ? void 0 : n2.icon] || r2.querySelector("[data-icon]").classList.add("hidden"), d2 = r2 ? r2.querySelector("[data-title]") : document.createElement("span"), this.apiUrl && (null === (l2 = this.apiFieldsMap) || void 0 === l2 ? void 0 : l2.title) && a2[this.apiFieldsMap.title] ? d2.textContent = a2[this.apiFieldsMap.title] : d2.textContent = a2.title || "", r2 || u.append(d2), r2 ? c = r2.querySelector("[data-remove]") : (c = document.createElement("span"), c.textContent = "X", u.append(c)), c.addEventListener("click", (() => {
          ...
          loadMore() {
            return s(this, void 0, void 0, (function* () {
              ...
              if (this.apiUrl && !this.isLoading && this.hasMore && this.apiLoadMore) {
                this.isLoading = true;
                try {
                  const n2 = new URL(this.apiUrl), o2 = (null === (e3 = this.apiFieldsMap) || void 0 === e3 ? void 0 : e3.page) || (null === (t3 = this.apiFieldsMap) || void 0 === t3 ? void 0 : t3.offset) || "page", l2 = !!(null === (i3 = this.apiFieldsMap) || void 0 === i3 ? void 0 : i3.offset), a2 = "object" == typeof this.apiLoadMore ? this.apiLoadMore.perPage : 10;
                  if (l2) {
                    const e4 = this.currentPage * a2;
                  ...
                  n2.searchParams.set((null === (s2 = this.apiFieldsMap) || void 0 === s2 ? void 0 : s2.limit) || "limit", a2.toString());
                  const r2 = yield fetch(n2.toString(), this.apiOptions || {}), d2 = yield r2.json(), c = this.apiDataPart ? d2[this.apiDataPart] : d2.results, h = d2.count || 0, u = this.currentPage * a2;
                  c && c.length > 0 ? (this.remoteOptions = [...this.remoteOptions || [], ...c], this.buildOptionsFromRemoteData(c), this.hasMore = u < h) : this.hasMore = false;
                } catch (e4) {
          ...
          buildFloatingUI() {
            if ("undefined" != typeof FloatingUIDOM && FloatingUIDOM.computePosition) {
              ...
              const i3 = { placement: r.POSITIONS[this.dropdownPlacement] || "bottom", strategy: "fixed", middleware: t3 }, s2 = () => {
                FloatingUIDOM.computePosition(e3, this.dropdown, i3).then((({ x: e4, y: t4, placement: i4 }) => {
              ...
              s2();
              const n2 = FloatingUIDOM.autoUpdate(e3, this.dropdown, s2);
          ...
          buildOption(e3, t3, i3 = false, s2 = false, n2, l2 = "1", a2) {
            var r2;
            let d2 = null, c = null, h = null, u = null;
            const p = (0, o.htmlToElement)(this.optionTag || "<div></div>");
            if (p.setAttribute("data-value", t3), p.setAttribute("data-title-value", e3), p.setAttribute("tabIndex", l2), p.classList.add("cursor-pointer"), p.setAttribute("data-id", a2 || `${this.optionId}`), a2 || this.optionId++, i3 && p.classList.add("disabled"), s2 && (this.isMultiple ? this.value = [...this.value, t3] : this.value = t3), this.optionTemplate && (d2 = (0, o.htmlToElement)(this.optionTemplate), p.append(d2)), d2 ? (c = d2.querySelector("[data-title]"), c.textContent = e3 || "") : p.textContent = e3 || "", n2) {
              if (n2.icon) {
                const t4 = (0, o.htmlToElement)(null !== (r2 = this.apiIconTag) && void 0 !== r2 ? r2 : n2.icon);
                if (t4.classList.add("max-w-full"), this.apiUrl && (t4.setAttribute("alt", e3), t4.setAttribute("src", n2.icon)), d2) h = d2.querySelector("[data-icon]"), h.append(t4);
                else {
                  const e4 = (0, o.htmlToElement)("<div></div>");
                  this.iconClasses && (0, o.classToClassList)(this.iconClasses, e4), e4.append(t4), p.append(e4);
                }
              }
              if (n2.description) if (d2) u = d2.querySelector("[data-description]"), u && u.append(n2.description);
              else {
                const e4 = (0, o.htmlToElement)("<div></div>");
                e4.textContent = n2.description, this.descriptionClasses && (0, o.classToClassList)(this.descriptionClasses, e4), p.append(e4);
              }
            }
            d2 && d2.querySelector("[data-icon]") && !n2 && !(null == n2 ? void 0 : n2.icon) && d2.querySelector("[data-icon]").classList.add("hidden"), this.value && (this.isMultiple ? this.value.includes(t3) : this.value === t3) && p.classList.add("selected"), i3 || p.addEventListener("click", (() => this.onSelectOption(t3))), this.optionClasses && (0, o.classToClassList)(this.optionClasses, p), this.dropdown && this.dropdown.append(p), s2 && this.setNewValue();
          }
          ...
          apiRequest() {
            return s(this, arguments, void 0, (function* (e3 = "") {
              var t3, i3, s2, n2, o2, l2, a2, r2, d2, c;
              try {
                const h = new URL(this.apiUrl), u = new URLSearchParams(null !== (t3 = this.apiQuery) && void 0 !== t3 ? t3 : ""), p = null !== (i3 = this.apiOptions) && void 0 !== i3 ? i3 : {}, m = null !== (s2 = this.apiSearchQueryKey) && void 0 !== s2 ? s2 : "q", g = (null != e3 ? e3 : "").trim().toLowerCase();
                if ("" !== g && u.set(m, encodeURIComponent(g)), this.apiLoadMore) {
                  const e4 = "object" == typeof this.apiLoadMore ? this.apiLoadMore.perPage : 10, t4 = null !== (a2 = null !== (o2 = null === (n2 = this.apiFieldsMap) || void 0 === n2 ? void 0 : n2.page) && void 0 !== o2 ? o2 : null === (l2 = this.apiFieldsMap) || void 0 === l2 ? void 0 : l2.offset) && void 0 !== a2 ? a2 : "page", i4 = null !== (d2 = null === (r2 = this.apiFieldsMap) || void 0 === r2 ? void 0 : r2.limit) && void 0 !== d2 ? d2 : "limit", s3 = Boolean(null === (c = this.apiFieldsMap) || void 0 === c ? void 0 : c.offset);
                  u.delete(t4), u.delete(i4), u.set(t4, s3 ? "0" : "1"), u.set(i4, String(e4));
                }
                h.search = u.toString();
                const v = yield fetch(h.toString(), p), f = yield v.json();
          ...
          buildOriginalOption(e3, t3, i3, s2, n2, l2) {
            ...
            a2.setAttribute("value", t3), s2 && a2.setAttribute("disabled", "disabled"), n2 && a2.setAttribute("selected", "selected"), i3 && a2.setAttribute("data-id", i3), a2.setAttribute("data-hs-select-option", JSON.stringify(l2)), a2.innerText = e3, this.el.append(a2);
          }
          ...
          focusMenuItem(e3) {
            ...
            if (!t3.length) return;
            const i3 = this.dropdown.querySelector(".hs-select-option-highlighted"), s2 = i3 ? t3.indexOf(i3) : -1, n2 = "next" === e3 ? (s2 + 1) % t3.length : (s2 - 1 + t3.length) % t3.length;
            i3 && i3.classList.remove("hs-select-option-highlighted"), t3[n2].classList.add("hs-select-option-highlighted"), t3[n2].focus();
          }
          onStartEnd(e3 = true) {
            ...
            t3[s2].classList.add("hs-select-option-highlighted"), t3[s2].focus();
          }
          destroy() {
            var e3;
          ...
          close(e3 = false) {
            ...
            })), null === (n2 = this.dropdown.querySelector(".hs-select-option-highlighted")) || void 0 === n2 || n2.classList.remove("hs-select-option-highlighted"), this._isOpened = false, window.HSAccessibilityObserver && this.accessibilityComponent && window.HSAccessibilityObserver.updateComponentState(this.accessibilityComponent, this._isOpened);
          }
          addOption(e3) {
          ...
          static autoInit() {
            ...
            }))), window.$hsSelectCollection && (window.$hsSelectCollection = window.$hsSelectCollection.filter((({ element: e3 }) => document.contains(e3.el)))), document.querySelectorAll("[data-hs-select]:not(.--prevent-on-load-init)").forEach(((e3) => {
        ...
        class l extends o.default {
          ...
          show() {
            ...
            this.animationInProcess = true, this.el.classList.add("open"), (null === (e3 = null == this ? void 0 : this.el) || void 0 === e3 ? void 0 : e3.ariaExpanded) && (this.el.ariaExpanded = "true"), this.content.classList.add("open"), this.content.classList.remove("hidden"), this.content.style.height = "0", setTimeout((() => {
              this.content.style.height = `${this.content.scrollHeight}px`, this.fireEvent("beforeOpen", this.el), (0, n.dispatch)("beforeOpen.hs.collapse", this.el, this.el);
            })), (0, n.afterTransition)(this.content, (() => {
              this.content.style.height = "", this.fireEvent("open", this.el), (0, n.dispatch)("open.hs.collapse", this.el, this.el), this.animationInProcess = false;
            }));
          }
          hide() {
            var e3;
            ...
            this.animationInProcess = true, this.el.classList.remove("open"), (null === (e3 = null == this ? void 0 : this.el) || void 0 === e3 ? void 0 : e3.ariaExpanded) && (this.el.ariaExpanded = "false"), this.content.style.height = `${this.content.scrollHeight}px`, setTimeout((() => {
              ...
              this.content.classList.add("hidden"), this.content.style.height = "", this.fireEvent("hide", this.el), (0, n.dispatch)("hide.hs.collapse", this.el, this.el), this.animationInProcess = false;
        ...
        class o extends n.default {
          constructor(e3, t3) {
            super(e3, t3);
            const i3 = e3.getAttribute("data-hs-theme-switch"), s2 = i3 ? JSON.parse(i3) : {}, n2 = Object.assign(Object.assign({}, s2), t3);
            this.theme = (null == n2 ? void 0 : n2.theme) || localStorage.getItem("hs_theme") || "default", this.type = (null == n2 ? void 0 : n2.type) || "change", this.init();
          }
          elementChange(e3) {
          ...
          addSystemThemeObserver() {
            o.systemThemeObserver || (o.systemThemeObserver = (e3) => {
              var t3;
          ...
          removeSystemThemeObserver() {
            o.systemThemeObserver && (window.matchMedia("(prefers-color-scheme: dark)").removeEventListener("change", o.systemThemeObserver), o.systemThemeObserver = null);
          }
          ...
          setAppearance(e3 = this.theme, t3 = true, i3 = true) {
            const s2 = document.querySelector("html"), n2 = this.setResetStyles();
            t3 && localStorage.setItem("hs_theme", e3);
            let o2 = e3;
            "default" === o2 && (o2 = "light"), "auto" === o2 && (o2 = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), s2.classList.remove("light", "dark", "default", "auto"), "auto" === e3 ? s2.classList.add("auto", o2) : s2.classList.add(o2), setTimeout((() => n2.remove())), i3 && window.dispatchEvent(new CustomEvent("on-hs-appearance-change", { detail: e3 }));
          }
          destroy() {
        ...
        o.systemThemeObserver = null, window.addEventListener("load", (() => {
          o.autoInit();
        ...
        class l extends o.default {
          constructor(e3, t3) {
            var i3, s2;
            super(e3, t3);
            const n2 = e3.getAttribute("data-hs-scroll-nav"), o2 = n2 ? JSON.parse(n2) : {}, l2 = Object.assign(Object.assign(Object.assign({}, { paging: true, autoCentering: false }), o2), t3);
            this.paging = null === (i3 = l2.paging) || void 0 === i3 || i3, this.autoCentering = null !== (s2 = l2.autoCentering) && void 0 !== s2 && s2, this.body = this.el.querySelector(".hs-scroll-nav-body"), this.items = this.body ? Array.from(this.body.querySelectorAll(":scope > *")) : [], this.prev = this.el.querySelector(".hs-scroll-nav-prev") || null, this.next = this.el.querySelector(".hs-scroll-nav-next") || null, this.setCurrentState(), this.init();
          }
          init() {
            if (!this.body || !this.items.length) return false;
            this.createCollection(window.$hsScrollNavCollection, this), this.setCurrentState(), this.paging ? (this.prev && this.buildPrev(), this.next && this.buildNext()) : (this.prev && this.buildPrevSingle(), this.next && this.buildNextSingle()), this.autoCentering && this.scrollToActiveElement(), this.body.addEventListener("scroll", (0, n.debounce)((() => this.setCurrentState()), 200)), window.addEventListener("resize", (0, n.debounce)((() => {
          ...
          getCenterVisibleItem() {
            ...
            let t3 = null, i3 = 1 / 0;
            return this.items.forEach(((s2) => {
              const n2 = s2.offsetLeft + s2.offsetWidth / 2, o2 = Math.abs(n2 - e3);
              o2 < i3 && (i3 = o2, t3 = s2);
            })), t3;
          }
          getFirstVisibleItem() {
          ...
          getLastVisibleItem() {
            ...
            for (let t3 = this.items.length - 1; t3 >= 0; t3--) {
              const i3 = this.items[t3], s2 = i3.getBoundingClientRect();
              if (s2.left < e3.right && s2.right > e3.left) return i3;
            }
            return null;
          }
          getVisibleItemsCount() {
            ...
            for (let s2 of this.items) {
              if (i3 += s2.offsetWidth, !(i3 <= e3)) break;
              t3++;
            }
            return t3;
          }
          ...
          goTo(e3, t3) {
            ...
            new IntersectionObserver(((i3, s2) => {
              i3.forEach(((i4) => {
                i4.target === e3 && i4.isIntersecting && ("function" == typeof t3 && t3(), s2.disconnect());
              }));
        ...
        class o extends n.default {
          constructor(e3, t3) {
            super(e3, t3);
            const i3 = e3.getAttribute("data-hs-toggle-count"), s2 = i3 ? JSON.parse(i3) : {}, n2 = Object.assign(Object.assign({}, s2), t3);
        ...
        class l extends o.default {
          ...
          show() {
            ...
            this.el.classList.add("active"), (null === (e3 = null == this ? void 0 : this.toggle) || void 0 === e3 ? void 0 : e3.ariaExpanded) && (this.toggle.ariaExpanded = "true"), this.fireEvent("beforeOpen", this.el), (0, n.dispatch)("beforeOpen.hs.accordion", this.el, this.el), this.content.style.display = "block", this.content.style.height = "0", setTimeout((() => {
              this.content.style.height = `${this.content.scrollHeight}px`, (0, n.afterTransition)(this.content, (() => {
                this.content.style.display = "block", this.content.style.height = "", this.fireEvent("open", this.el), (0, n.dispatch)("open.hs.accordion", this.el, this.el);
              }));
            }));
          }
          hide() {
            var e3;
            if (!this.el.classList.contains("active")) return false;
            this.el.classList.remove("active"), (null === (e3 = null == this ? void 0 : this.toggle) || void 0 === e3 ? void 0 : e3.ariaExpanded) && (this.toggle.ariaExpanded = "false"), this.fireEvent("beforeClose", this.el), (0, n.dispatch)("beforeClose.hs.accordion", this.el, this.el), this.content.style.height = `${this.content.scrollHeight}px`, setTimeout((() => {
              this.content.style.height = "0";
            })), (0, n.afterTransition)(this.content, (() => {
              this.content.style.display = "none", this.content.style.height = "", this.fireEvent("close", this.el), (0, n.dispatch)("close.hs.accordion", this.el, this.el);
            }));
          }
          update() {
        ...
        class l extends o.default {
          constructor(e3, t3 = {}) {
            ...
            const i3 = e3.getAttribute("data-hs-scrollspy-options"), s2 = i3 ? JSON.parse(i3) : {}, n2 = Object.assign(Object.assign({}, s2), t3);
          ...
          update(e3, t3) {
            const i3 = parseInt((0, n.getClassProperty)(this.el, "--scrollspy-offset", "0")), s2 = parseInt((0, n.getClassProperty)(t3, "--scrollspy-offset")) || i3, o2 = e3.target === document ? 0 : parseInt(String(e3.target.getBoundingClientRect().top)), l2 = parseInt(String(t3.getBoundingClientRect().top)) - s2 - o2, a = t3.offsetHeight;
            if (this.ignoreScrollUp || this.isScrollingDown ? l2 <= 0 && l2 + a > 0 : l2 <= 0 && l2 < a) {
              ...
              this.fireEvent("afterScroll", e4), (0, n.dispatch)("afterScroll.hs.scrollspy", e4, this.el);
            }
          }
          scrollTo(e3) {
            const t3 = e3.getAttribute("href"), i3 = document.querySelector(t3), s2 = parseInt((0, n.getClassProperty)(this.el, "--scrollspy-offset", "0")), o2 = parseInt((0, n.getClassProperty)(i3, "--scrollspy-offset")) || s2, l2 = this.scrollable === document ? 0 : this.scrollable.offsetTop, a = i3.offsetTop - o2 - l2, r = this.scrollable === document ? window : this.scrollable, d = () => {
            ...
            (0, n.dispatch)("beforeScroll.hs.scrollspy", this.el, this.el), c instanceof Promise ? c.then((() => d())) : d();
          }
          destroy() {
        ...
        class l extends o.default {
          constructor(e3, t3, i3) {
            ...
            const s2 = e3.getAttribute("data-hs-tree-view"), n2 = s2 ? JSON.parse(s2) : {}, o2 = Object.assign(Object.assign({}, n2), t3);
          ...
          elementClick(e3, t3, i3) {
            ...
            e3.metaKey || e3.shiftKey || this.unselectItem(i3), this.selectItem(t3, i3), this.fireEvent("click", { el: t3, data: i3 }), (0, n.dispatch)("click.hs.treeView", this.el, { el: t3, data: i3 });
          }
          controlChange(e3, t3) {
          ...
          initItems() {
            this.el.querySelectorAll("[data-hs-tree-view-item]").forEach(((e3, t3) => {
              var i3, s2;
              const n2 = JSON.parse(e3.getAttribute("data-hs-tree-view-item"));
          ...
          getPath(e3) {
            var t3;
            const i3 = [];
            let s2 = e3.closest("[data-hs-tree-view-item]");
            for (; s2; ) {
              const e4 = JSON.parse(s2.getAttribute("data-hs-tree-view-item"));
              i3.push(e4.value), s2 = null === (t3 = s2.parentElement) || void 0 === t3 ? void 0 : t3.closest("[data-hs-tree-view-item]");
            }
        ...
        class r extends l.default {
          ...
          init() {
            this.createCollection(window.$hsComboBoxCollection, this), this.build(), "undefined" != typeof window && (window.HSAccessibilityObserver || (window.HSAccessibilityObserver = new a.default()), this.setupAccessibility());
          }
          build() {
          ...
          sortItems() {
            ...
            return this.items.sort(((e3, t3) => {
              const i3 = e3.querySelector("[data-hs-combo-box-value]").textContent, s2 = t3.querySelector("[data-hs-combo-box-value]").textContent;
          ...
          itemRender(e3) {
            var t3;
            const i3 = e3.querySelector("[data-hs-combo-box-value]").textContent, s2 = null !== (t3 = JSON.parse(e3.getAttribute("data-hs-combo-box-item-stored-data"))) && void 0 !== t3 ? t3 : null;
          ...
          jsonItemsRender(e3) {
            e3.forEach(((e4, t3) => {
              ...
              i3.setAttribute("data-hs-combo-box-item-stored-data", JSON.stringify(e4)), i3.querySelectorAll("[data-hs-combo-box-output-item-field]").forEach(((t4) => {
                ...
                t4.textContent = null != s2 ? s2 : "", !s2 && t4.hasAttribute("data-hs-combo-box-output-item-hide-if-empty") && (t4.style.display = "none");
                ...
                t4.setAttribute("data-hs-combo-box-search-text", null != s2 ? s2 : "");
          ...
          onEnter() {
            var e3, t3, i3;
            if (this.isOpened) {
              const s2 = this.output.querySelector(".hs-combo-box-output-item-highlighted");
              s2 && (this.close(null !== (t3 = null === (e3 = s2.querySelector("[data-hs-combo-box-value]")) || void 0 === e3 ? void 0 : e3.getAttribute("data-hs-combo-box-search-text")) && void 0 !== t3 ? t3 : null, null !== (i3 = JSON.parse(s2.getAttribute("data-hs-combo-box-item-stored-data"))) && void 0 !== i3 ? i3 : null), this.input && this.input.focus());
            } else this.open();
          }
          focusMenuItem(e3) {
            var t3;
            ...
            const n2 = i3.querySelector(".hs-combo-box-output-item-highlighted"), o2 = n2 ? s2.indexOf(n2) : -1, l2 = "next" === e3 ? (o2 + 1) % s2.length : (o2 - 1 + s2.length) % s2.length;
            n2 && n2.classList.remove("hs-combo-box-output-item-highlighted"), s2[l2].classList.add("hs-combo-box-output-item-highlighted"), s2[l2].focus(), this.input.value = s2[l2].querySelector("[data-hs-combo-box-value]").getAttribute("data-hs-combo-box-search-text");
          }
          onStartEnd(e3 = true) {
            var t3;
            const i3 = null !== (t3 = this.itemsWrapper) && void 0 !== t3 ? t3 : this.output;
            ...
            const s2 = Array.from(i3.querySelectorAll(":scope > *:not(.--exclude-accessibility)")).filter(((e4) => "none" !== e4.style.display));
            if (!s2.length) return false;
            const n2 = i3.querySelector(".hs-combo-box-output-item-highlighted");
            this.setHighlighted(n2, s2[0], this.input);
          }
          getCurrentData() {
          ...
          close(e3, t3 = null) {
            var i3, s2;
            return !this.animationInProcess && (this.preventVisibility ? (this.setValueAndClear(e3, t3), "" !== this.input.value ? this.el.classList.add("has-value") : this.el.classList.remove("has-value"), false) : (this.preserveSelectionOnEmpty || "" !== this.input.value.trim() || (this.selected = "", this.value = ""), this.animationInProcess = true, (null === (i3 = null == this ? void 0 : this.input) || void 0 === i3 ? void 0 : i3.ariaExpanded) && (this.input.ariaExpanded = "false"), (null === (s2 = null == this ? void 0 : this.toggle) || void 0 === s2 ? void 0 : s2.ariaExpanded) && (this.toggle.ariaExpanded = "false"), this.el.classList.remove("active"), this.preventAutoPosition || (this.output.classList.remove("bottom-full", "top-full"), this.output.style.marginTop = "", this.output.style.marginBottom = ""), (0, o.afterTransition)(this.output, (() => {
          ...
          static autoInit() {
            ...
            }))), window.$hsComboBoxCollection && (window.$hsComboBoxCollection = window.$hsComboBoxCollection.filter((({ element: e3 }) => document.contains(e3.el)))), document.querySelectorAll("[data-hs-combo-box]:not(.--prevent-on-load-init)").forEach(((e3) => {
        ...
        class l extends o.default {
          constructor(e3, t3) {
            var i3;
            super(e3, t3);
            const s2 = e3.getAttribute("data-hs-layout-splitter"), n2 = s2 ? JSON.parse(s2) : {}, o2 = Object.assign(Object.assign({}, n2), t3);
          ...
          buildControl(e3, t3, i3 = "horizontal") {
            ...
            if (this.isSplittersAddedManually) {
              if (s2 = null == t3 ? void 0 : t3.previousElementSibling, !s2) return false;
              s2.style.display = "";
            } else s2 = (0, n.htmlToElement)("horizontal" === i3 ? this.horizontalSplitterTemplate : this.verticalSplitterTemplate), (0, n.classToClassList)("horizontal" === i3 ? this.horizontalSplitterClasses : this.verticalSplitterClasses, s2), s2.classList.add("hs-layout-splitter-control");
            const o2 = { el: s2, direction: i3, prev: e3, next: t3 };
            "horizontal" === i3 ? this.horizontalControls.push(o2) : this.verticalControls.push(o2), this.bindListeners(o2), t3 && !this.isSplittersAddedManually && e3.insertAdjacentElement("afterend", s2);
          }
          getSplitterItemParsedParam(e3) {
            const t3 = e3.getAttribute("data-hs-layout-splitter-item");
            return (0, n.isJson)(t3) ? JSON.parse(t3) : t3;
          }
          getContainerSize(e3, t3) {
            return t3 ? e3.getBoundingClientRect().width : e3.getBoundingClientRect().height;
          }
          getMaxFlexSize(e3, t3, i3) {
            const s2 = this.getSplitterItemSingleParam(e3, t3);
            return "number" == typeof s2 ? s2 / 100 * i3 : 0;
          }
          ...
          updateSingleSplitter(e3) {
            const t3 = e3.getAttribute("data-hs-layout-splitter-item"), i3 = (0, n.isJson)(t3) ? JSON.parse(t3) : t3, s2 = (0, n.isJson)(t3) ? i3.dynamicSize : t3;
            e3.style.flex = `${s2} 1 0`;
          }
          ...
          updateSplitterItemParam(e3, t3) {
            const i3 = this.getSplitterItemParsedParam(e3), s2 = t3.toFixed(1), n2 = "object" == typeof i3 ? JSON.stringify(Object.assign(Object.assign({}, i3), { dynamicSize: +s2 })) : s2;
            e3.setAttribute("data-hs-layout-splitter-item", n2);
          }
          onPointerDownHandler(e3) {
            const { el: t3, prev: i3, next: s2 } = e3;
            t3.classList.add("dragging"), i3.classList.add("dragging"), s2.classList.add("dragging"), document.body.style.userSelect = "none";
          }
          onPointerUpHandler() {
            document.body.style.userSelect = "";
          }
          onPointerMoveHandler(e3, t3, i3) {
            const { prev: s2, next: n2 } = t3, o2 = t3.el.closest("horizontal" === i3 ? "[data-hs-layout-splitter-horizontal-group]" : "[data-hs-layout-splitter-vertical-group]"), l2 = "horizontal" === i3, a = this.getContainerSize(o2, l2), r = this.calculateAvailableSize(o2, s2, n2, l2, a), d = this.calculateResizedSizes(e3, s2, r, l2), c = this.enforceLimits(d, s2, n2, a, r);
            this.applySizes(s2, n2, c, a);
          }
          bindListeners(e3) {
            const { el: t3 } = e3;
          ...
          calculateAvailableSize(e3, t3, i3, s2, n2) {
            const o2 = e3.querySelectorAll(":scope > [data-hs-layout-splitter-item]");
            return n2 - Array.from(o2).reduce(((e4, n3) => {
              if (n3 === t3 || n3 === i3) return e4;
              const o3 = n3.getBoundingClientRect();
              return e4 + ("fixed" === window.getComputedStyle(n3).position ? 0 : s2 ? o3.width : o3.height);
            }), 0);
          }
          calculateResizedSizes(e3, t3, i3, s2) {
            const n2 = s2 ? t3.getBoundingClientRect().left : t3.getBoundingClientRect().top;
            let o2 = Math.max(0, Math.min((s2 ? e3.clientX : e3.clientY) - n2, i3));
            return { previousSize: o2, nextSize: i3 - o2 };
          }
          enforceLimits(e3, t3, i3, s2, o2) {
            const l2 = this.getMaxFlexSize(t3, "minSize", s2), a = this.getMaxFlexSize(i3, "minSize", s2), r = this.getMaxFlexSize(t3, "preLimitSize", s2), d = this.getMaxFlexSize(i3, "preLimitSize", s2);
            let { previousSize: c, nextSize: h } = e3;
            h < a ? (h = a, c = o2 - h) : c < l2 && (c = l2, h = o2 - c);
            const u = { prev: t3, next: i3, previousSize: c.toFixed(), previousFlexSize: c / s2 * 100, previousPreLimitSize: r, previousPreLimitFlexSize: r / s2 * 100, previousMinSize: l2, previousMinFlexSize: l2 / s2 * 100, nextSize: h.toFixed(), nextFlexSize: h / s2 * 100, nextPreLimitSize: d, nextPreLimitFlexSize: d / s2 * 100, nextMinSize: a, nextMinFlexSize: a / s2 * 100, static: { prev: { minSize: this.getSplitterItemSingleParam(t3, "minSize"), preLimitSize: this.getSplitterItemSingleParam(t3, "preLimitSize") }, next: { minSize: this.getSplitterItemSingleParam(i3, "minSize"), preLimitSize: this.getSplitterItemSingleParam(i3, "preLimitSize") } } };
            return h < a ? (this.fireEvent("onNextLimit", u), (0, n.dispatch)("onNextLimit.hs.layoutSplitter", this.el, u)) : c < l2 && (this.fireEvent("onPrevLimit", u), (0, n.dispatch)("onPrevLimit.hs.layoutSplitter", this.el, u)), c <= r && (this.fireEvent("onPrevPreLimit", u), (0, n.dispatch)("onPrevPreLimit.hs.layoutSplitter", this.el, u)), h <= d && (this.fireEvent("onNextPreLimit", u), (0, n.dispatch)("onNextPreLimit.hs.layoutSplitter", this.el, u)), this.fireEvent("drag", u), (0, n.dispatch)("drag.hs.layoutSplitter", this.el, u), { previousSize: c, nextSize: h };
          }
          applySizes(e3, t3, i3, s2) {
            const { previousSize: n2, nextSize: o2 } = i3, l2 = n2 / s2 * 100;
          ...
          getData(e3) {
            var t3, i3;
            const s2 = e3.closest("[data-hs-layout-splitter-horizontal-group], [data-hs-layout-splitter-vertical-group]");
            if (!s2) throw new Error("Element is not inside a valid layout splitter container.");
            const n2 = s2.matches("[data-hs-layout-splitter-horizontal-group]"), o2 = this.getContainerSize(s2, n2), l2 = this.getSplitterItemSingleParam(e3, "dynamicSize") || 0, a = this.getMaxFlexSize(e3, "minSize", o2), r = this.getMaxFlexSize(e3, "preLimitSize", o2), d = a / o2 * 100, c = r / o2 * 100;
            return { el: e3, dynamicSize: +(l2 / 100 * o2).toFixed(), dynamicFlexSize: l2, minSize: +a.toFixed(), minFlexSize: d, preLimitSize: +r.toFixed(), preLimitFlexSize: c, static: { minSize: null !== (t3 = this.getSplitterItemSingleParam(e3, "minSize")) && void 0 !== t3 ? t3 : null, preLimitSize: null !== (i3 = this.getSplitterItemSingleParam(e3, "preLimitSize")) && void 0 !== i3 ? i3 : null } };
          }
          ...
          updateFlexValues(e3) {
            ...
            if (e3.forEach((({ id: e4, breakpoints: s2 }) => {
              const n2 = document.getElementById(e4);
              if (n2) {
                const e5 = ((e6) => {
                  const t4 = Object.keys(e6).map(Number).sort(((e7, t5) => e7 - t5));
                  for (let s3 = t4.length - 1; s3 >= 0; s3--) if (i3 >= t4[s3]) return e6[t4[s3]];
                  return 0;
                })(s2);
                this.updateSplitterItemParam(n2, e5), n2.style.flex = `${e5.toFixed(1)} 1 0`, t3 += e5;
              }
            })), 100 !== t3) {
              const i4 = 100 / t3;
              e3.forEach((({ id: e4 }) => {
        ...
        l.isListenersInitialized = false, l.onDocumentPointerMove = (e3) => {
          ...
          const s2 = i3.element.activeSplitter;
          s2 && ("vertical" === s2.direction ? i3.element.onPointerMoveHandler(e3, s2, "vertical") : i3.element.onPointerMoveHandler(e3, s2, "horizontal"));
        ...
        class l extends o.default {
          constructor(e3, t3, i3) {
            var s2, n2, o2, l2, a, r, d, c, h, u, p, m, g, v, f, y, w, b, C, S, x;
          ...
          initInfoFrom(e3) {
            var t3;
            const i3 = null !== (t3 = e3.querySelector("[data-hs-datatable-info-from]")) && void 0 !== t3 ? t3 : null, { start: s2 } = this.dataTable.page.info();
            i3 && (i3.innerText = `${s2 + 1}`);
          }
          initInfoTo(e3) {
            var t3;
            const i3 = null !== (t3 = e3.querySelector("[data-hs-datatable-info-to]")) && void 0 !== t3 ? t3 : null, { end: s2 } = this.dataTable.page.info();
            i3 && (i3.innerText = `${s2}`);
          }
          initInfoLength(e3) {
            var t3;
            const i3 = null !== (t3 = e3.querySelector("[data-hs-datatable-info-length]")) && void 0 !== t3 ? t3 : null, { recordsTotal: s2 } = this.dataTable.page.info();
            i3 && (i3.innerText = `${s2}`);
          }
          updateInfo() {
            this.initInfo();
          ...
          updatePaging(e3) {
            const { page: t3, pages: i3, length: s2 } = this.dataTable.page.info(), o2 = this.dataTable.rows({ search: "applied" }).count(), l2 = Math.ceil(o2 / s2), a = t3 + 1;
            let r = Math.max(1, a - Math.floor(this.maxPagesToShow / 2)), d = Math.min(l2, r + (this.maxPagesToShow - 1));
            d - r + 1 < this.maxPagesToShow && (r = Math.max(1, d - this.maxPagesToShow + 1)), e3.innerHTML = "", r > 1 && (this.buildPagingPage(1, e3), r > 2 && e3.appendChild((0, n.htmlToElement)('<span class="ellipsis">...</span>')));
            for (let t4 = r; t4 <= d; t4++) this.buildPagingPage(t4, e3);
            d < l2 && (d < l2 - 1 && e3.appendChild((0, n.htmlToElement)('<span class="ellipsis">...</span>')), this.buildPagingPage(l2, e3)), this.pagingPrevList.forEach(((e4) => this.disablePagingArrow(e4, 0 === t3))), this.pagingNextList.forEach(((e4) => this.disablePagingArrow(e4, t3 === i3 - 1))), this.pagingList.forEach(((e4) => this.hidePagingIfSinglePage(e4)));
          }
        ...
        Object.defineProperty(t2, "__esModule", { value: true });
        const n = i2(292), o = i2(223), l = s(i2(961)), a = s(i2(248));
        class r extends l.default {
          constructor(e3, t3, i3) {
            var s2, l2, a2, r2, d2, c2;
            ...
            this.autoClose = !isNaN(+g) && isFinite(+g) ? +g : o.BREAKPOINTS[g] || null, this.autoCloseEqualityType = null !== (d2 = v) && void 0 !== d2 ? d2 : null, this.openedBreakpoint = (!isNaN(+f) && isFinite(+f) ? +f : o.BREAKPOINTS[f]) || null, this.animationTarget = (null === (c2 = null == this ? void 0 : this.el) || void 0 === c2 ? void 0 : c2.querySelector(".hs-overlay-animation-target")) || this.el, this.initialZIndex = parseInt(getComputedStyle(this.el).zIndex, 10), this.onElementClickListener = [], this.onElementMinifierClickListener = [], this.initiallyOpened = document.body.classList.contains("hs-overlay-body-open"), this.init();
          }
          elementClick() {
            const e3 = () => {
              const e4 = { el: this.el, isOpened: !!this.el.classList.contains("open") };
              this.fireEvent("toggleClicked", e4), (0, n.dispatch)("toggleClicked.hs.overlay", this.el, e4);
            };
          ...
          elementMinifierClick() {
            const e3 = () => {
              ...
              this.fireEvent("toggleMinifierClicked", e4), (0, n.dispatch)("toggleMinifierClicked.hs.overlay", this.el, e4);
            };
          ...
          buildBackdrop() {
            ...
            for (const t4 of e3) (t4.startsWith("hs-overlay-backdrop-open:") || t4.includes(":hs-overlay-backdrop-open:")) && (s2 += ` ${t4}`);
            l2 || (i3 && (this.backdrop = document.querySelector(i3).cloneNode(true), this.backdrop.classList.remove("hidden"), s2 = `${this.backdrop.classList.toString()}`, this.backdrop.classList.value = ""), o2 && (this.onBackdropClickListener = () => this.backdropClick(), this.backdrop.addEventListener("click", this.onBackdropClickListener, true)), this.backdrop.setAttribute("data-hs-overlay-backdrop-template", ""), this.backdropParent.appendChild(this.backdrop), setTimeout((() => {
          ...
          collectToggleParameters(e3) {
            let t3 = {};
            return e3.forEach(((e4) => {
              const i3 = e4.getAttribute("data-hs-overlay-options"), s2 = i3 ? JSON.parse(i3) : {};
          ...
          open(e3 = null) {
            this.el.classList.contains("minified") && this.minify(false), this.hasDynamicZIndex && (r.currentZIndex < this.initialZIndex && (r.currentZIndex = this.initialZIndex), r.currentZIndex++, this.el.style.zIndex = `${r.currentZIndex}`);
            const t3 = document.querySelectorAll(".hs-overlay.open"), i3 = window.$hsOverlayCollection.find(((e4) => Array.from(t3).includes(e4.element.el) && !e4.element.isLayoutAffect)), s2 = document.querySelectorAll(`[data-hs-overlay="#${this.el.id}"]`), o2 = "true" !== (0, n.getClassProperty)(this.el, "--body-scroll", "false");
            ...
            o2 && (document.body.style.overflow = "hidden", this.emulateScrollbarSpace && (document.body.style.paddingRight = `${this.getScrollbarSize()}px`)), this.buildBackdrop(), this.checkTimer(), this.hideAuto(), s2.forEach(((e4) => {
              ...
              this.el.classList.add("open", "opened"), this.isLayoutAffect && document.body.classList.add("hs-overlay-body-open"), this.initiallyOpened || (this.el.focus(), this.el.style.outline = "none"), this.initiallyOpened = false, this.fireEvent("open", this.el), (0, n.dispatch)("open.hs.overlay", this.el, this.el), window.HSAccessibilityObserver && this.accessibilityComponent && window.HSAccessibilityObserver.updateComponentState(this.accessibilityComponent, true), this.hasAutofocus && this.focusElement(), "function" == typeof e3 && e3(), this.isElementVisible() && r.openedItemsQty++;
            }), 50);
          }
          close(e3 = false, t3 = null) {
            this.isElementVisible() && (r.openedItemsQty = r.openedItemsQty <= 0 ? 0 : r.openedItemsQty - 1), 0 === r.openedItemsQty && this.isLayoutAffect && document.body.classList.remove("hs-overlay-body-open");
            const i3 = (e4) => {
          ...
          static getInstance(e3, t3) {
            const i3 = "string" == typeof e3 ? document.querySelector(e3) : e3, s2 = (null == i3 ? void 0 : i3.getAttribute("data-hs-overlay")) ? i3.getAttribute("data-hs-overlay") : e3, n2 = window.$hsOverlayCollection.find(((e4) => e4.element.el === ("string" == typeof s2 ? document.querySelector(s2) : s2) || e4.element.el === ("string" == typeof s2 ? document.querySelector(s2) : s2)));
            return n2 ? t3 ? n2 : n2.element.el : null;
          }
          static autoInit() {
            window.$hsOverlayCollection || (window.$hsOverlayCollection = []), window.$hsOverlayCollection && (window.$hsOverlayCollection = window.$hsOverlayCollection.filter((({ element: e3 }) => document.contains(e3.el)))), document.querySelectorAll(".hs-overlay:not(.--prevent-on-load-init)").forEach(((e3) => {
          ...
          static minify(e3, t3) {
            const i3 = r.findInCollection(e3);
        ...
        const c = () => {
          ...
          (null === (e3 = window.$hsOverlayCollection) || void 0 === e3 ? void 0 : e3.length) && window.$hsOverlayCollection.forEach(((e4) => {
            var t3;
            const i3 = e4.element;
            (null === (t3 = i3.toggleMinifierButtons) || void 0 === t3 ? void 0 : t3.length) > 0 && i3.openedBreakpoint && (document.body.clientWidth >= i3.openedBreakpoint ? document.body.classList.add("hs-overlay-body-open") : document.body.classList.remove("hs-overlay-body-open"));
          }));
        };
        window.addEventListener("load", (() => {
          r.autoInit(), c(), h();
          ...
          ((e3, t3 = 150) => {
            d && clearTimeout(d), d = setTimeout(e3, t3);
          })((() => {
            (() => {
              ...
              window.$hsOverlayCollection.filter(((e3) => e3.element.openedBreakpoint)).forEach(((e3) => {
                ...
                document.body.clientWidth >= t3 ? e3.element.el.classList.contains("opened") || r.setOpened(t3, e3) : e3.element.el.classList.contains("opened") && (e3.element.el.classList.contains("minified") && e3.element.minify(false), e3.element.close(true));
              }));
            })();
          })), c(), (() => {
        ...
        class l extends o.default {
          constructor(e3, t3) {
            super(e3, t3);
            const i3 = e3.getAttribute("data-hs-stepper"), s2 = i3 ? JSON.parse(i3) : {}, n2 = Object.assign(Object.assign({}, s2), t3);
          ...
          nextClick() {
            var e3;
            if (this.fireEvent("beforeNext", this.currentIndex), (0, n.dispatch)("beforeNext.hs.stepper", this.el, this.currentIndex), null === (e3 = this.getNavItem(this.currentIndex)) || void 0 === e3 ? void 0 : e3.isProcessed) return this.disableAll(), false;
            this.goToNext();
          }
          skipClick() {
          ...
          finishBtnClick() {
            var e3;
            if (this.fireEvent("beforeFinish", this.currentIndex), (0, n.dispatch)("beforeFinish.hs.stepper", this.el, this.currentIndex), null === (e3 = this.getNavItem(this.currentIndex)) || void 0 === e3 ? void 0 : e3.isProcessed) return this.disableAll(), false;
          ...
          addNavItem(e3) {
            const { index: t3, isFinal: i3 = false, isCompleted: s2 = false, isSkip: n2 = false, isOptional: o2 = false, isDisabled: l2 = false, isProcessed: a = false, hasError: r = false } = JSON.parse(e3.getAttribute("data-hs-stepper-nav-item"));
            s2 && e3.classList.add("success"), n2 && e3.classList.add("skipped"), l2 && ("BUTTON" !== e3.tagName && "INPUT" !== e3.tagName || e3.setAttribute("disabled", "disabled"), e3.classList.add("disabled")), r && e3.classList.add("error"), this.navItems.push({ index: t3, isFinal: i3, isCompleted: s2, isSkip: n2, isOptional: o2, isDisabled: l2, isProcessed: a, hasError: r, el: e3 });
          }
          setCurrentNavItem() {
            this.navItems.forEach(((e3) => {
          ...
          setCurrentNavItemActions(e3) {
            e3.classList.add("active"), this.fireEvent("active", this.currentIndex), (0, n.dispatch)("active.hs.stepper", this.el, this.currentIndex);
          }
          ...
          addContentItem(e3) {
            const { index: t3, isFinal: i3 = false, isCompleted: s2 = false, isSkip: n2 = false } = JSON.parse(e3.getAttribute("data-hs-stepper-content-item"));
            s2 && e3.classList.add("success"), n2 && e3.classList.add("skipped"), this.contentItems.push({ index: t3, isFinal: i3, isCompleted: s2, isSkip: n2, el: e3 });
          }
          ...
          handleSkipButtonClick() {
            this.setSkipItem(), this.handleNextButtonClick(), this.fireEvent("skip", this.currentIndex), (0, n.dispatch)("skip.hs.stepper", this.el, this.currentIndex);
          }
          ...
          handleCompleteStepButtonClick() {
            this.setCompleteItem(), this.fireEvent("complete", this.currentIndex), (0, n.dispatch)("complete.hs.stepper", this.el, this.currentIndex), this.handleNextButtonClick(false), this.showFinishButton(), this.showCompleteStepButton(), this.checkForTheFirstStep(), this.completeStepBtn && this.changeTextAndDisableCompleteButtonIfStepCompleted(), this.showSkipButton();
          }
          buildFinishButton() {
          ...
          handleFinishButtonClick() {
            ...
            (s2 ? s2.el : null).classList.remove("active"), i3.style.display = "block", this.backBtn && (this.backBtn.style.display = "none"), this.nextBtn && (this.nextBtn.style.display = "none"), this.skipBtn && (this.skipBtn.style.display = "none"), this.completeStepBtn && (this.completeStepBtn.style.display = "none"), this.finishBtn && (this.finishBtn.style.display = "none"), this.resetBtn && (this.resetBtn.style.display = ""), t3.length <= 1 && (this.isCompleted = true, this.setCompleted()), this.fireEvent("finish", this.currentIndex), (0, n.dispatch)("finish.hs.stepper", this.el, this.currentIndex);
          }
          buildResetButton() {
        ...
        Object.defineProperty(t2, "__esModule", { value: true });
        const n = i2(292), o = i2(949), l = s(i2(961)), a = s(i2(248)), r = i2(223);
        class d extends l.default {
          constructor(e3, t3, i3) {
          ...
          onContextMenuHandler(e3) {
            ...
            d.closeCurrentlyOpened(), this.el.classList.contains("open") && !this.menu.classList.contains("hidden") ? (this.close(), document.body.style.overflow = "", document.body.style.paddingRight = "") : (document.body.style.overflow = "hidden", document.body.style.paddingRight = `${this.getScrollbarSize()}px`, this.open(t3));
          }
          onClickHandler(e3) {
            var t3;
          ...
          setupFloatingUI(e3) {
            const t3 = e3 || this.el, i3 = window.getComputedStyle(this.el), s2 = (i3.getPropertyValue("--placement") || "").trim(), n2 = (i3.getPropertyValue("--flip") || "true").trim(), l2 = (i3.getPropertyValue("--strategy") || "fixed").trim(), a2 = (i3.getPropertyValue("--offset") || "10").trim(), d2 = (i3.getPropertyValue("--gpu-acceleration") || "true").trim(), c = (window.getComputedStyle(this.el).getPropertyValue("--adaptive") || "adaptive").replace(" ", ""), h = l2, u = parseInt(a2, 10), p = r.POSITIONS[s2] || "bottom-start", m = [..."true" === n2 ? [(0, o.flip)()] : [], (0, o.offset)(u)], g = { placement: p, strategy: h, middleware: m }, v = (e4) => {
          ...
          close(e3 = true) {
            ...
            (() => {
              var e4;
              this.menu.style.margin = null, (null === (e4 = null == this ? void 0 : this.toggle) || void 0 === e4 ? void 0 : e4.ariaExpanded) && (this.toggle.ariaExpanded = "false"), this.el.classList.remove("open"), this.openedViaKeyboard = false, this.fireEvent("close", this.el), (0, n.dispatch)("close.hs.dropdown", this.el, this.el);
            })();
          }
          forceClearState() {
          ...
          static findInCollection(e3) {
            return window.$hsDropdownCollection.find(((t3) => e3 instanceof d ? t3.element.el === e3.el : "string" == typeof e3 ? t3.element.el === document.querySelector(e3) : t3.element.el === e3)) || null;
          }
          static getInstance(e3, t3) {
          ...
          static autoInit() {
            if (!window.$hsDropdownCollection) {
              ...
              window.addEventListener("resize", (() => {
                window.innerWidth !== e3 && (e3 = innerWidth, d.closeCurrentlyOpened(null, false));
              }));
            }
          ...
          static open(e3, t3 = false) {
            const i3 = d.findInCollection(e3);
          ...
          static closeCurrentlyOpened(e3 = null, t3 = true) {
            ...
            let s2 = i3 ? window.$hsDropdownCollection.filter(((e4) => e4.element.el.classList.contains("open") && e4.element.menu.closest(".hs-dropdown").parentElement.closest(".hs-dropdown") === i3)) : window.$hsDropdownCollection.filter(((e4) => e4.element.el.classList.contains("open")));
            if (e3) {
          ...
          static on(e3, t3, i3) {
            const s2 = d.findInCollection(t3);
            s2 && (s2.element.events[e3] = i3);
          }
          isOpened() {
            return this.isOpen();
        ...
        })), "undefined" != typeof window && (window.HSDropdown = d), t2.default = d;
        ...
        class l extends o.default {
          constructor(e3, t3) {
            super(e3, t3);
            const i3 = e3.getAttribute("data-hs-remove-element-options"), s2 = i3 ? JSON.parse(i3) : {}, n2 = Object.assign(Object.assign({}, s2), t3);
            this.removeTargetId = this.el.getAttribute("data-hs-remove-element"), this.removeTarget = document.querySelector(this.removeTargetId), this.removeTargetAnimationClass = (null == n2 ? void 0 : n2.removeTargetAnimationClass) || "hs-removing", this.removeTarget && this.init();
          }
          elementClick() {
            this.remove();
          }
        ...
        const s = ["top", "right", "bottom", "left"], n = ["start", "end"], o = s.reduce(((e3, t3) => e3.concat(t3, t3 + "-" + n[0], t3 + "-" + n[1])), []), l = Math.min, a = Math.max, r = Math.round, d = Math.floor, c = (e3) => ({ x: e3, y: e3 }), h = { left: "right", right: "left", bottom: "top", top: "bottom" }, u = { start: "end", end: "start" };
        function p(e3, t3, i3) {
          return a(e3, l(t3, i3));
        }
        function m(e3, t3) {
        ...
        function T(e3, t3, i3) {
          ...
          const o2 = w(t3), l2 = b(t3), a2 = y(l2), r2 = g(t3), d2 = "y" === o2, c2 = s2.x + s2.width / 2 - n2.width / 2, h2 = s2.y + s2.height / 2 - n2.height / 2, u2 = s2[a2] / 2 - n2[a2] / 2;
          let p2;
          switch (r2) {
            case "top":
              p2 = { x: c2, y: s2.y - n2.height };
              break;
            case "bottom":
              p2 = { x: c2, y: s2.y + s2.height };
              break;
            case "right":
        ...
        async function k(e3, t3) {
          var i3;
          void 0 === t3 && (t3 = {});
          const { x: s2, y: n2, platform: o2, rects: l2, elements: a2, strategy: r2 } = e3, { boundary: d2 = "clippingAncestors", rootBoundary: c2 = "viewport", elementContext: h2 = "floating", altBoundary: u2 = false, padding: p2 = 0 } = m(t3, e3), g2 = L(p2), v2 = a2[u2 ? "floating" === h2 ? "reference" : "floating" : h2], f2 = E(await o2.getClippingRect({ element: null == (i3 = await (null == o2.isElement ? void 0 : o2.isElement(v2))) || i3 ? v2 : v2.contextElement || await (null == o2.getDocumentElement ? void 0 : o2.getDocumentElement(a2.floating)), boundary: d2, rootBoundary: c2, strategy: r2 })), y2 = "floating" === h2 ? { x: s2, y: n2, width: l2.floating.width, height: l2.floating.height } : l2.reference, w2 = await (null == o2.getOffsetParent ? void 0 : o2.getOffsetParent(a2.floating)), b2 = await (null == o2.isElement ? void 0 : o2.isElement(w2)) && await (null == o2.getScale ? void 0 : o2.getScale(w2)) || { x: 1, y: 1 }, C2 = E(o2.convertOffsetParentRelativeRectToViewportRelativeRect ? await o2.convertOffsetParentRelativeRectToViewportRelativeRect({ elements: a2, rect: y2, offsetParent: w2, strategy: r2 }) : y2);
        ...
        function D(e3) {
          return H(e3) ? (e3.nodeName || "").toLowerCase() : "#document";
        }
        function P(e3) {
          var t3;
        ...
        function $(e3) {
          var t3;
          return null == (t3 = (H(e3) ? e3.ownerDocument : e3.document) || window.document) ? void 0 : t3.documentElement;
        }
        function H(e3) {
          return !!O() && (e3 instanceof Node || e3 instanceof P(e3).Node);
        }
        function N(e3) {
          return !!O() && (e3 instanceof Element || e3 instanceof P(e3).Element);
        }
        function B(e3) {
          return !!O() && (e3 instanceof HTMLElement || e3 instanceof P(e3).HTMLElement);
        }
        function q(e3) {
          return !(!O() || "undefined" == typeof ShadowRoot) && (e3 instanceof ShadowRoot || e3 instanceof P(e3).ShadowRoot);
        }
        function F(e3) {
          const { overflow: t3, overflowX: i3, overflowY: s2, display: n2 } = W(e3);
          return /auto|scroll|overlay|hidden|clip/.test(t3 + s2 + i3) && !["inline", "contents"].includes(n2);
        }
        function _2(e3) {
          return ["table", "td", "th"].includes(D(e3));
        }
        function R(e3) {
        ...
        function z(e3) {
          return ["html", "body", "#document"].includes(D(e3));
        }
        function W(e3) {
          return P(e3).getComputedStyle(e3);
        }
        function U(e3) {
          return N(e3) ? { scrollLeft: e3.scrollLeft, scrollTop: e3.scrollTop } : { scrollLeft: e3.scrollX, scrollTop: e3.scrollY };
        }
        function Y(e3) {
          if ("html" === D(e3)) return e3;
          const t3 = e3.assignedSlot || e3.parentNode || q(e3) && e3.host || $(e3);
          return q(t3) ? t3.host : t3;
        }
        function K(e3) {
          const t3 = Y(e3);
          return z(t3) ? e3.ownerDocument ? e3.ownerDocument.body : e3.body : B(t3) && F(t3) ? t3 : K(t3);
        }
        function J(e3, t3, i3) {
          var s2;
          void 0 === t3 && (t3 = []), void 0 === i3 && (i3 = true);
          const n2 = K(e3), o2 = n2 === (null == (s2 = e3.ownerDocument) ? void 0 : s2.body), l2 = P(n2);
          if (o2) {
            const e4 = Q(l2);
            return t3.concat(l2, l2.visualViewport || [], F(n2) ? n2 : [], e4 && i3 ? J(e4) : []);
          }
          return t3.concat(n2, J(n2, [], i3));
        }
        function Q(e3) {
        ...
        function Z(e3) {
          ...
          const n2 = B(e3), o2 = n2 ? e3.offsetWidth : i3, l2 = n2 ? e3.offsetHeight : s2, a2 = r(i3) !== o2 || r(s2) !== l2;
          return a2 && (i3 = o2, s2 = l2), { width: i3, height: s2, $: a2 };
        }
        function G(e3) {
          return N(e3) ? e3 : e3.contextElement;
        }
        function X(e3) {
          const t3 = G(e3);
          if (!B(t3)) return c(1);
          const i3 = t3.getBoundingClientRect(), { width: s2, height: n2, $: o2 } = Z(t3);
          let l2 = (o2 ? r(i3.width) : i3.width) / s2, a2 = (o2 ? r(i3.height) : i3.height) / n2;
        ...
        function ie(e3, t3, i3, s2) {
          ...
          const n2 = e3.getBoundingClientRect(), o2 = G(e3);
          let l2 = c(1);
          t3 && (s2 ? N(s2) && (l2 = X(s2)) : l2 = X(e3));
          const a2 = (function(e4, t4, i4) {
            return void 0 === t4 && (t4 = false), !(!i4 || t4 && i4 !== P(e4)) && t4;
          })(o2, i3, s2) ? te(o2) : c(0);
          let r2 = (n2.left + a2.x) / l2.x, d2 = (n2.top + a2.y) / l2.y, h2 = n2.width / l2.x, u2 = n2.height / l2.y;
          if (o2) {
            const e4 = P(o2), t4 = s2 && N(s2) ? P(s2) : s2;
            let i4 = e4, n3 = Q(i4);
            for (; n3 && s2 && t4 !== i4; ) {
              const e5 = X(n3), t5 = n3.getBoundingClientRect(), s3 = W(n3), o3 = t5.left + (n3.clientLeft + parseFloat(s3.paddingLeft)) * e5.x, l3 = t5.top + (n3.clientTop + parseFloat(s3.paddingTop)) * e5.y;
              r2 *= e5.x, d2 *= e5.y, h2 *= e5.x, u2 *= e5.y, r2 += o3, d2 += l3, i4 = P(n3), n3 = Q(i4);
            }
          }
          return E({ width: h2, height: u2, x: r2, y: d2 });
        }
        function se(e3, t3) {
          const i3 = U(e3).scrollLeft;
        ...
        function oe(e3, t3, i3) {
          ...
          if ("viewport" === t3) s2 = (function(e4, t4) {
            const i4 = P(e4), s3 = $(e4), n2 = i4.visualViewport;
            let o2 = s3.clientWidth, l2 = s3.clientHeight, a2 = 0, r2 = 0;
            if (n2) {
              o2 = n2.width, l2 = n2.height;
              const e5 = j();
              (!e5 || e5 && "fixed" === t4) && (a2 = n2.offsetLeft, r2 = n2.offsetTop);
            }
            return { width: o2, height: l2, x: a2, y: r2 };
          })(e3, i3);
          else if ("document" === t3) s2 = (function(e4) {
            const t4 = $(e4), i4 = U(e4), s3 = e4.ownerDocument.body, n2 = a(t4.scrollWidth, t4.clientWidth, s3.scrollWidth, s3.clientWidth), o2 = a(t4.scrollHeight, t4.clientHeight, s3.scrollHeight, s3.clientHeight);
            let l2 = -i4.scrollLeft + se(e4);
            const r2 = -i4.scrollTop;
            return "rtl" === W(s3).direction && (l2 += a(t4.clientWidth, s3.clientWidth) - n2), { width: n2, height: o2, x: l2, y: r2 };
          })($(e3));
          else if (N(t3)) s2 = (function(e4, t4) {
            const i4 = ie(e4, true, "fixed" === t4), s3 = i4.top + e4.clientTop, n2 = i4.left + e4.clientLeft, o2 = B(e4) ? X(e4) : c(1);
        ...
        function le(e3, t3) {
          const i3 = Y(e3);
          return !(i3 === t3 || !N(i3) || z(i3)) && ("fixed" === W(i3).position || le(i3, t3));
        }
        function ae(e3, t3, i3) {
          const s2 = B(t3), n2 = $(t3), o2 = "fixed" === i3, l2 = ie(e3, true, o2, t3);
          let a2 = { scrollLeft: 0, scrollTop: 0 };
          const r2 = c(0);
          if (s2 || !s2 && !o2) if (("body" !== D(t3) || F(n2)) && (a2 = U(t3)), s2) {
            const e4 = ie(t3, true, o2, t3);
            r2.x = e4.x + t3.clientLeft, r2.y = e4.y + t3.clientTop;
          } else n2 && (r2.x = se(n2));
          const d2 = !n2 || s2 || o2 ? c(0) : ne(n2, a2);
          return { x: l2.left + a2.scrollLeft - r2.x - d2.x, y: l2.top + a2.scrollTop - r2.y - d2.y, width: l2.width, height: l2.height };
        }
        function re(e3) {
          return "static" === W(e3).position;
        }
        function de(e3, t3) {
          if (!B(e3) || "fixed" === W(e3).position) return null;
          if (t3) return t3(e3);
        ...
        function ce(e3, t3) {
          ...
          if (!B(e3)) {
            let t4 = Y(e3);
            for (; t4 && !z(t4); ) {
              if (N(t4) && !re(t4)) return t4;
              t4 = Y(t4);
            }
            return i3;
          }
          let s2 = de(e3, t3);
          for (; s2 && _2(s2) && re(s2); ) s2 = de(s2, t3);
          return s2 && z(s2) && re(s2) && !V(s2) ? i3 : s2 || (function(e4) {
            let t4 = Y(e4);
            for (; B(t4) && !z(t4); ) {
              if (V(t4)) return t4;
              if (R(t4)) return null;
        ...
        const he = { convertOffsetParentRelativeRectToViewportRelativeRect: function(e3) {
          ...
          const o2 = "fixed" === n2, l2 = $(s2), a2 = !!t3 && R(t3.floating);
          if (s2 === l2 || a2 && o2) return i3;
          let r2 = { scrollLeft: 0, scrollTop: 0 }, d2 = c(1);
          const h2 = c(0), u2 = B(s2);
          if ((u2 || !u2 && !o2) && (("body" !== D(s2) || F(l2)) && (r2 = U(s2)), B(s2))) {
            const e4 = ie(s2);
            d2 = X(s2), h2.x = e4.x + s2.clientLeft, h2.y = e4.y + s2.clientTop;
          }
          const p2 = !l2 || u2 || o2 ? c(0) : ne(l2, r2, true);
          return { width: i3.width * d2.x, height: i3.height * d2.y, x: i3.x * d2.x - r2.scrollLeft * d2.x + h2.x + p2.x, y: i3.y * d2.y - r2.scrollTop * d2.y + h2.y + p2.y };
          ...
          const o2 = [..."clippingAncestors" === i3 ? R(t3) ? [] : (function(e4, t4) {
            const i4 = t4.get(e4);
            if (i4) return i4;
            let s3 = J(e4, [], false).filter(((e5) => N(e5) && "body" !== D(e5))), n3 = null;
            const o3 = "fixed" === W(e4).position;
            let l2 = o3 ? Y(e4) : e4;
            for (; N(l2) && !z(l2); ) {
              const t5 = W(l2), i5 = V(l2);
              i5 || "fixed" !== t5.position || (n3 = null), (o3 ? !i5 && !n3 : !i5 && "static" === t5.position && n3 && ["absolute", "fixed"].includes(n3.position) || F(l2) && !i5 && le(e4, l2)) ? s3 = s3.filter(((e5) => e5 !== l2)) : n3 = t5, l2 = Y(l2);
            }
            return t4.set(e4, s3), s3;
          })(t3, this._c) : [].concat(i3), s2], r2 = o2[0], d2 = o2.reduce(((e4, i4) => {
            const s3 = oe(t3, i4, n2);
            return e4.top = a(s3.top, e4.top), e4.right = l(s3.right, e4.right), e4.bottom = l(s3.bottom, e4.bottom), e4.left = a(s3.left, e4.left), e4;
          }), oe(t3, r2, n2));
          return { width: d2.right - d2.left, height: d2.bottom - d2.top, x: d2.left, y: d2.top };
        }, getOffsetParent: ce, getElementRects: async function(e3) {
          const t3 = this.getOffsetParent || ce, i3 = this.getDimensions, s2 = await i3(e3.floating);
          return { reference: ae(e3.reference, await t3(e3.floating), e3.strategy), floating: { x: 0, y: 0, width: s2.width, height: s2.height } };
        ...
        }, getScale: X, isElement: N, isRTL: function(e3) {
        ...
        function pe(e3, t3, i3, s2) {
          void 0 === s2 && (s2 = {});
          const { ancestorScroll: n2 = true, ancestorResize: o2 = true, elementResize: r2 = "function" == typeof ResizeObserver, layoutShift: c2 = "function" == typeof IntersectionObserver, animationFrame: h2 = false } = s2, u2 = G(e3), p2 = n2 || o2 ? [...u2 ? J(u2) : [], ...J(t3)] : [];
          p2.forEach(((e4) => {
            n2 && e4.addEventListener("scroll", i3, { passive: true }), o2 && e4.addEventListener("resize", i3);
          }));
          const m2 = u2 && c2 ? (function(e4, t4) {
            let i4, s3 = null;
            const n3 = $(e4);
            function o3() {
              var e5;
            ...
            return (function r3(c3, h3) {
              void 0 === c3 && (c3 = false), void 0 === h3 && (h3 = 1), o3();
              const u3 = e4.getBoundingClientRect(), { left: p3, top: m3, width: g3, height: v3 } = u3;
              if (c3 || t4(), !g3 || !v3) return;
              const f3 = { rootMargin: -d(m3) + "px " + -d(n3.clientWidth - (p3 + g3)) + "px " + -d(n3.clientHeight - (m3 + v3)) + "px " + -d(p3) + "px", threshold: a(0, l(1, h3)) || 1 };
              let y3 = true;
              function w2(t5) {
                const s4 = t5[0].intersectionRatio;
                if (s4 !== h3) {
                  if (!y3) return r3();
                  s4 ? r3(false, s4) : i4 = setTimeout((() => {
                    r3(false, 1e-7);
                  }), 1e3);
                }
                1 !== s4 || ue(u3, e4.getBoundingClientRect()) || r3(), y3 = false;
              }
              try {
                s3 = new IntersectionObserver(w2, { ...f3, root: n3.ownerDocument });
              } catch (e5) {
                s3 = new IntersectionObserver(w2, f3);
              }
              s3.observe(e4);
            })(true), o3;
          })(u2, i3) : null;
          ...
          return h2 && (function t4() {
            const s3 = ie(e3);
            y2 && !ue(y2, s3) && i3();
            y2 = s3, g2 = requestAnimationFrame(t4);
          })(), i3(), () => {
            var e4;
            p2.forEach(((e5) => {
        ...
        const me = k, ge = function(e3) {
          return void 0 === e3 && (e3 = 0), { name: "offset", options: e3, async fn(t3) {
            var i3, s2;
            const { x: n2, y: o2, placement: l2, middlewareData: a2 } = t3, r2 = await (async function(e4, t4) {
              const { placement: i4, platform: s3, elements: n3 } = e4, o3 = await (null == s3.isRTL ? void 0 : s3.isRTL(n3.floating)), l3 = g(i4), a3 = v(i4), r3 = "y" === w(i4), d2 = ["left", "top"].includes(l3) ? -1 : 1, c2 = o3 && r3 ? -1 : 1, h2 = m(t4, e4);
              ...
              return a3 && "number" == typeof f2 && (p2 = "end" === a3 ? -1 * f2 : f2), r3 ? { x: p2 * c2, y: u2 * d2 } : { x: u2 * d2, y: p2 * c2 };
            })(t3, e3);
            return l2 === (null == (i3 = a2.offset) ? void 0 : i3.placement) && null != (s2 = a2.arrow) && s2.alignmentOffset ? {} : { x: n2 + r2.x, y: o2 + r2.y, data: { ...r2, placement: l2 } };
          } };
        }, ve = function(e3) {
          return void 0 === e3 && (e3 = {}), { name: "autoPlacement", options: e3, async fn(t3) {
            var i3, s2, n2;
            const { rects: l2, middlewareData: a2, placement: r2, platform: d2, elements: c2 } = t3, { crossAxis: h2 = false, alignment: u2, allowedPlacements: p2 = o, autoAlignment: f2 = true, ...y2 } = m(e3, t3), w2 = void 0 !== u2 || p2 === o ? (function(e4, t4, i4) {
            ...
            if (null == L2) return {};
            const E2 = C(L2, l2, await (null == d2.isRTL ? void 0 : d2.isRTL(c2.floating)));
            if (r2 !== L2) return { reset: { placement: w2[0] } };
            const T2 = [b2[g(L2)], b2[E2[0]], b2[E2[1]]], I2 = [...(null == (s2 = a2.autoPlacement) ? void 0 : s2.overflows) || [], { placement: L2, overflows: T2 }], A2 = w2[x2 + 1];
            ...
            })).sort(((e4, t4) => e4[1] - t4[1])), O2 = (null == (n2 = M2.filter(((e4) => e4[2].slice(0, v(e4[0]) ? 2 : 3).every(((e5) => e5 <= 0))))[0]) ? void 0 : n2[0]) || M2[0][0];
            return O2 !== r2 ? { data: { index: x2 + 1, overflows: I2 }, reset: { placement: O2 } } : {};
          } };
        }, fe = function(e3) {
          return void 0 === e3 && (e3 = {}), { name: "shift", options: e3, async fn(t3) {
            const { x: i3, y: s2, placement: n2 } = t3, { mainAxis: o2 = true, crossAxis: l2 = false, limiter: a2 = { fn: (e4) => {
              let { x: t4, y: i4 } = e4;
              return { x: t4, y: i4 };
            } }, ...r2 } = m(e3, t3), d2 = { x: i3, y: s2 }, c2 = await k(t3, r2), h2 = w(g(n2)), u2 = f(h2);
            let v2 = d2[u2], y2 = d2[h2];
            if (o2) {
              const e4 = "y" === u2 ? "bottom" : "right";
              v2 = p(v2 + c2["y" === u2 ? "top" : "left"], v2, v2 - c2[e4]);
            }
            if (l2) {
              const e4 = "y" === h2 ? "bottom" : "right";
              y2 = p(y2 + c2["y" === h2 ? "top" : "left"], y2, y2 - c2[e4]);
            }
          ...
          return void 0 === e3 && (e3 = {}), { name: "flip", options: e3, async fn(t3) {
            var i3, s2;
            const { placement: n2, middlewareData: o2, rects: l2, initialPlacement: a2, platform: r2, elements: d2 } = t3, { mainAxis: c2 = true, crossAxis: h2 = true, fallbackPlacements: u2, fallbackStrategy: p2 = "bestFit", fallbackAxisSideDirection: f2 = "none", flipAlignment: y2 = true, ...b2 } = m(e3, t3);
            if (null != (i3 = o2.arrow) && i3.alignmentOffset) return {};
            const L2 = g(n2), E2 = w(a2), T2 = g(a2) === a2, I2 = await (null == r2.isRTL ? void 0 : r2.isRTL(d2.floating)), A2 = u2 || (T2 || !y2 ? [x(a2)] : (function(e4) {
              const t4 = x(e4);
              return [S(e4), t4, S(t4)];
            })(a2)), M2 = "none" !== f2;
            !u2 && M2 && A2.push(...(function(e4, t4, i4, s3) {
              const n3 = v(e4);
            ...
            const O2 = [a2, ...A2], D2 = await k(t3, b2), P2 = [];
            let $2 = (null == (s2 = o2.flip) ? void 0 : s2.overflows) || [];
            if (c2 && P2.push(D2[L2]), h2) {
              const e4 = C(n2, l2, I2);
              P2.push(D2[e4[0]], D2[e4[1]]);
            }
            if ($2 = [...$2, { placement: n2, overflows: P2 }], !P2.every(((e4) => e4 <= 0))) {
              var H2, N2;
              const e4 = ((null == (H2 = o2.flip) ? void 0 : H2.index) || 0) + 1, t4 = O2[e4];
              if (t4) return { data: { index: e4, overflows: $2 }, reset: { placement: t4 } };
              let i4 = null == (N2 = $2.filter(((e5) => e5.overflows[0] <= 0)).sort(((e5, t5) => e5.overflows[1] - t5.overflows[1]))[0]) ? void 0 : N2.placement;
              if (!i4) switch (p2) {
                case "bestFit": {
                  var B2;
                  const e5 = null == (B2 = $2.filter(((e6) => {
                    if (M2) {
          ...
          return void 0 === e3 && (e3 = {}), { name: "size", options: e3, async fn(t3) {
            var i3, s2;
            const { placement: n2, rects: o2, platform: r2, elements: d2 } = t3, { apply: c2 = () => {
            }, ...h2 } = m(e3, t3), u2 = await k(t3, h2), p2 = g(n2), f2 = v(n2), y2 = "y" === w(n2), { width: b2, height: C2 } = o2.floating;
            let S2, x2;
            "top" === p2 || "bottom" === p2 ? (S2 = p2, x2 = f2 === (await (null == r2.isRTL ? void 0 : r2.isRTL(d2.floating)) ? "start" : "end") ? "left" : "right") : (x2 = p2, S2 = "end" === f2 ? "top" : "bottom");
            const L2 = C2 - u2.top - u2.bottom, E2 = b2 - u2.left - u2.right, T2 = l(C2 - u2[S2], L2), I2 = l(b2 - u2[x2], E2), A2 = !t3.middlewareData.shift;
            let M2 = T2, O2 = I2;
            if (null != (i3 = t3.middlewareData.shift) && i3.enabled.x && (O2 = E2), null != (s2 = t3.middlewareData.shift) && s2.enabled.y && (M2 = L2), A2 && !f2) {
              const e4 = a(u2.left, 0), t4 = a(u2.right, 0), i4 = a(u2.top, 0), s3 = a(u2.bottom, 0);
              y2 ? O2 = b2 - 2 * (0 !== e4 || 0 !== t4 ? e4 + t4 : a(u2.left, u2.right)) : M2 = C2 - 2 * (0 !== i4 || 0 !== s3 ? i4 + s3 : a(u2.top, u2.bottom));
            }
            await c2({ ...t3, availableWidth: O2, availableHeight: M2 });
            const D2 = await r2.getDimensions(d2.floating);
            return b2 !== D2.width || C2 !== D2.height ? { reset: { rects: true } } : {};
          } };
        }, be = function(e3) {
          return void 0 === e3 && (e3 = {}), { name: "hide", options: e3, async fn(t3) {
            ...
            switch (s2) {
              case "referenceHidden": {
                const e4 = I(await k(t3, { ...n2, elementContext: "reference" }), i3.reference);
                return { data: { referenceHiddenOffsets: e4, referenceHidden: A(e4) } };
              }
              case "escaped": {
                const e4 = I(await k(t3, { ...n2, altBoundary: true }), i3.floating);
          ...
          const { x: i3, y: s2, placement: n2, rects: o2, platform: a2, elements: r2, middlewareData: d2 } = t3, { element: c2, padding: h2 = 0 } = m(e3, t3) || {};
          if (null == c2) return {};
          const u2 = L(h2), g2 = { x: i3, y: s2 }, f2 = b(n2), w2 = y(f2), C2 = await a2.getDimensions(c2), S2 = "y" === f2, x2 = S2 ? "top" : "left", E2 = S2 ? "bottom" : "right", T2 = S2 ? "clientHeight" : "clientWidth", k2 = o2.reference[w2] + o2.reference[f2] - g2[f2] - o2.floating[w2], I2 = g2[f2] - o2.reference[f2], A2 = await (null == a2.getOffsetParent ? void 0 : a2.getOffsetParent(c2));
          let M2 = A2 ? A2[T2] : 0;
          M2 && await (null == a2.isElement ? void 0 : a2.isElement(A2)) || (M2 = r2.floating[T2] || o2.floating[w2]);
          const O2 = k2 / 2 - I2 / 2, D2 = M2 / 2 - C2[w2] / 2 - 1, P2 = l(u2[x2], D2), $2 = l(u2[E2], D2), H2 = P2, N2 = M2 - C2[w2] - $2, B2 = M2 / 2 - C2[w2] / 2 + O2, q2 = p(H2, B2, N2), F2 = !d2.arrow && null != v(n2) && B2 !== q2 && o2.reference[w2] / 2 - (B2 < H2 ? P2 : $2) - C2[w2] / 2 < 0, _3 = F2 ? B2 < H2 ? B2 - H2 : B2 - N2 : 0;
          return { [f2]: g2[f2] + _3, data: { [f2]: q2, centerOffset: B2 - q2 - _3, ...F2 && { alignmentOffset: _3 } }, reset: F2 };
        } }), Se = function(e3) {
          return void 0 === e3 && (e3 = {}), { name: "inline", options: e3, async fn(t3) {
            const { placement: i3, elements: s2, rects: n2, platform: o2, strategy: r2 } = t3, { padding: d2 = 2, x: c2, y: h2 } = m(e3, t3), u2 = Array.from(await (null == o2.getClientRects ? void 0 : o2.getClientRects(s2.reference)) || []), p2 = (function(e4) {
              ...
              return i4.map(((e5) => E(M(e5))));
            })(u2), v2 = E(M(u2)), f2 = L(d2);
            const y2 = await o2.getElementRects({ reference: { getBoundingClientRect: function() {
              if (2 === p2.length && p2[0].left > p2[1].right && null != c2 && null != h2) return p2.find(((e4) => c2 > e4.left - f2.left && c2 < e4.right + f2.right && h2 > e4.top - f2.top && h2 < e4.bottom + f2.bottom)) || v2;
              if (p2.length >= 2) {
                if ("y" === w(i3)) {
                  const e5 = p2[0], t5 = p2[p2.length - 1], s4 = "top" === g(i3), n4 = e5.top, o4 = t5.bottom, l2 = s4 ? e5.left : t5.left, a2 = s4 ? e5.right : t5.right;
                  return { top: n4, bottom: o4, left: l2, right: a2, width: a2 - l2, height: o4 - n4, x: l2, y: n4 };
                }
                const e4 = "left" === g(i3), t4 = a(...p2.map(((e5) => e5.right))), s3 = l(...p2.map(((e5) => e5.left))), n3 = p2.filter(((i4) => e4 ? i4.left === s3 : i4.right === t4)), o3 = n3[0].top, r3 = n3[n3.length - 1].bottom;
                return { top: o3, bottom: r3, left: s3, right: t4, width: t4 - s3, height: r3 - o3, x: s3, y: o3 };
              }
              return v2;
            } }, floating: s2.floating, strategy: r2 });
            return n2.reference.x !== y2.reference.x || n2.reference.y !== y2.reference.y || n2.reference.width !== y2.reference.width || n2.reference.height !== y2.reference.height ? { reset: { rects: y2 } } : {};
          } };
        }, xe = function(e3) {
          return void 0 === e3 && (e3 = {}), { options: e3, fn(t3) {
            const { x: i3, y: s2, placement: n2, rects: o2, middlewareData: l2 } = t3, { offset: a2 = 0, mainAxis: r2 = true, crossAxis: d2 = true } = m(e3, t3), c2 = { x: i3, y: s2 }, h2 = w(n2), u2 = f(h2);
            let p2 = c2[u2], v2 = c2[h2];
          ...
          return (async (e4, t4, i4) => {
            const { placement: s3 = "bottom", strategy: n3 = "absolute", middleware: o3 = [], platform: l2 } = i4, a2 = o3.filter(Boolean), r2 = await (null == l2.isRTL ? void 0 : l2.isRTL(t4));
            let d2 = await l2.getElementRects({ reference: e4, floating: t4, strategy: n3 }), { x: c2, y: h2 } = T(d2, s3, r2), u2 = s3, p2 = {}, m2 = 0;
            for (let i5 = 0; i5 < a2.length; i5++) {
              const { name: o4, fn: g2 } = a2[i5], { x: v2, y: f2, data: y2, reset: w2 } = await g2({ x: c2, y: h2, initialPlacement: s3, placement: u2, strategy: n3, middlewareData: p2, rects: d2, platform: l2, elements: { reference: e4, floating: t4 } });
              c2 = null != v2 ? v2 : c2, h2 = null != f2 ? f2 : h2, p2 = { ...p2, [o4]: { ...p2[o4], ...y2 } }, w2 && m2 <= 50 && (m2++, "object" == typeof w2 && (w2.placement && (u2 = w2.placement), w2.rects && (d2 = true === w2.rects ? await l2.getElementRects({ reference: e4, floating: t4, strategy: n3 }) : w2.rects), { x: c2, y: h2 } = T(d2, u2, r2)), i5 = -1);
            }
            return { x: c2, y: h2, placement: u2, strategy: n3, middlewareData: p2 };
          })(e3, t3, { ...n2, platform: o2 });
        };
      }, 957: (e2, t2, i2) => {
        "use strict";
        Object.defineProperty(t2, "__esModule", { value: true });
        const s = i2(292), n = i2(255), o = { getClassProperty: s.getClassProperty, afterTransition: s.afterTransition, autoInit(e3 = "all") {
        ...
        Object.defineProperty(t2, "__esModule", { value: true });
        const o = i2(949), l = i2(292), a = n(i2(961)), r = i2(223);
        class d extends a.default {
          ...
          positionTooltip(e3) {
            return s(this, void 0, void 0, (function* () {
              const t3 = "auto" === e3 ? "top" : e3, i3 = "auto" === e3 ? ["bottom", "left", "right"] : this.getFallbackPlacements(t3), s2 = [(0, o.offset)(5), (0, o.flip)({ fallbackPlacements: i3 })];
              return yield (0, o.computePosition)(this.toggle, this.content, { placement: t3, strategy: this.strategy || "fixed", middleware: s2 });
            }));
          }
          ...
          buildFloatingUI() {
            ...
            const e3 = this.placement.startsWith("auto"), t3 = (0, l.getClassProperty)(this.el, "--placement"), i3 = e3 || (!t3 || "" === t3) ? "auto" : r.POSITIONS[this.placement] || this.placement;
          ...
          _show() {
            this.content.classList.remove("hidden"), "window" === this.scope && this.content.classList.add("show"), "false" !== this.preventFloatingUI || this.cleanupAutoUpdate || this.buildFloatingUI(), setTimeout((() => {
              this.el.classList.add("show"), this.fireEvent("show", this.el), (0, l.dispatch)("show.hs.tooltip", this.el, this.el);
            }));
          }
          show() {
          ...
          hide() {
            this.el.classList.remove("show"), "window" === this.scope && this.content.classList.remove("show"), "false" === this.preventFloatingUI && this.cleanupAutoUpdate && (this.cleanupAutoUpdate(), this.cleanupAutoUpdate = null), this.fireEvent("hide", this.el), (0, l.dispatch)("hide.hs.tooltip", this.el, this.el), (0, l.afterTransition)(this.content, (() => {
              if (this.el.classList.contains("show")) return false;
          ...
          static findInCollection(e3) {
            return window.$hsTooltipCollection.find(((t3) => e3 instanceof d ? t3.element.el === e3.el : "string" == typeof e3 ? t3.element.el === document.querySelector(e3) : t3.element.el === e3)) || null;
          }
          static getInstance(e3, t3 = false) {
        ...
        window.addEventListener("load", (() => {
          d.autoInit();
        })), "undefined" != typeof window && (window.HSTooltip = d), t2.default = d;
      } }, t = {};
      function i(s) {
        var n = t[s];
...
//# sourceMappingURL=preline_dist_index__js.js.map
