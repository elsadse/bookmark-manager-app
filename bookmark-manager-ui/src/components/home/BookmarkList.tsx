        ...
        <div className="rounded-8 bg-neutral-0 dark:bg-neutral-d-800 h-68 w-84.5">
            ...
            <div className="h-1O.25 flex flex-row justify-between items-center gap-x-2 px-4 py-3 border-t border-neutral-300 dark:border-neutral-d-500">
                <div className="flex flex-row gap-x-4">
                    <BookmarkListCardFooterInfo icon={iconVisitCount} information={bookmark.visitsCount.toString()} />
                    <BookmarkListCardFooterInfo icon={iconTime} information={bookmark.lastVisitTime === null ? "Never" : bookmark.lastVisitTime.toLocaleDateString("en-US", { month: "short", day: "numeric" })} />
                    <BookmarkListCardFooterInfo icon={iconDate} information={bookmark.creationTime.toLocaleDateString("en-US", { month: "short", day: "numeric" })} />
                </div>
                {!bookmark.isArchived && bookmark.isPinned && <img src={iconPin} className="size-4" alt="icon pin" />}
                {bookmark.isArchived &&
